...
namespace AERP.Business.BusinessAction
{
    public class SalesOrderMasterAndDetailsBA : ISalesOrderMasterAndDetailsBA
    {
        ...
        public IBaseEntityResponse<SalesOrderMasterAndDetails> InsertSalesOrderApproval(SalesOrderMasterAndDetails item)
        {
            ...
            try
            {
                entityResponse = _SalesOrderMasterAndDetailsDataProvider.InsertSalesOrderApproval(item);
            }
            catch (Exception ex)
            {
                entityResponse.Message.Add(new MessageDTO
        ...
        public IBaseEntityCollectionResponse<SalesOrderMasterAndDetails> GetSalesOrderForApproval(SalesOrderMasterAndDetailsSearchRequest searchRequest)
        {
            ...
            {
                if (_SalesOrderMasterAndDetailsDataProvider != null)
                    SalesOrderMasterAndDetailsCollection = _SalesOrderMasterAndDetailsDataProvider.GetSalesOrderForApproval(searchRequest);
                else
                {
                    SalesOrderMasterAndDetailsCollection.Message.Add(new MessageDTO
                    {
