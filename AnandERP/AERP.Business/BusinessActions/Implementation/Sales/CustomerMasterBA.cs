...
namespace AERP.Business.BusinessAction
{
    public class CustomerMasterBA : ICustomerMasterBA
    {
        ...
        public IBaseEntityCollectionResponse<CustomerMaster> GetCustomerBranchSearchListAll(CustomerMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<CustomerMaster> CustomerMasterMasterCollection = new BaseEntityCollectionResponse<CustomerMaster>();
            try
            {
                if (_CustomerMasterDataProvider != null)
                    CustomerMasterMasterCollection = _CustomerMasterDataProvider.GetContractNumberSearchListAll(searchRequest);
                else
                {
                    CustomerMasterMasterCollection.Message.Add(new MessageDTO
                    {
                        ErrorMessage = Resources.Null_Object_Exception,
                        MessageType = MessageTypeEnum.Error
                    });
                    CustomerMasterMasterCollection.CollectionResponse = null;
                }
            }
            catch (Exception ex)
            {
            ...
            return CustomerMasterMasterCollection;
        }
