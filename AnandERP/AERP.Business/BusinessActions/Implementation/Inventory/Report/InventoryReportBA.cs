    ...
    public class InventoryReportBA : IInventoryReportBA
    {
       ...
       //Item Master Missing Exaception Report
        ...
        public IBaseEntityCollectionResponse<InventoryReport> GetSaleOrderMonthlyDeliveryReportReportList(InventoryReportSearchRequest searchRequest)
        {
            ...
            {
                if (_InventoryReportDataProvider != null)
                    InventoryReportCollection = _InventoryReportDataProvider.GetSaleOrderMonthlyDeliveryReportReportList(searchRequest);
                else
                {
                    InventoryReportCollection.Message.Add(new MessageDTO
                    {
        ...
        public IBaseEntityCollectionResponse<InventoryReport> GetInventoryStockRegisterMonthWiseReportList(InventoryReportSearchRequest searchRequest)
        {
            ...
            {
                if (_InventoryReportDataProvider != null)
                    InventoryReportCollection = _InventoryReportDataProvider.GetInventoryStockRegisterMonthWiseReportList(searchRequest);
                else
                {
                    InventoryReportCollection.Message.Add(new MessageDTO
                    {
