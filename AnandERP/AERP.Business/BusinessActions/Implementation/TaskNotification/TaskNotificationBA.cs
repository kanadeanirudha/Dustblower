...
namespace AERP.Business.BusinessAction
{
    public class TaskNotificationBA : ITaskNotificationBA
    {
        ...
        {
            IBaseEntityResponse<TaskNotification> entityResponse = new BaseEntityResponse<TaskNotification>();
            try
            {
                entityResponse = _TaskNotificationDataProvider.GetNotificationCountEmployeewise(item);
            }
            catch (Exception ex)
            {
