    ...
    public class SaleContractFixAttendanceBA : ISaleContractFixAttendanceBA
    {
        ...
        public IBaseEntityResponse<SaleContractFixAttendance> InsertContractFixAttendanceApproval(SaleContractFixAttendance item)
        {
            ...
            try
            {
                if (_SaleContractFixAttendanceDataProvider != null)
                {
                    entityResponse = _SaleContractFixAttendanceDataProvider.InsertContractFixAttendanceApproval(item);
                }
                else
                {
                    entityResponse.Message.Add(new MessageDTO
        ...
        public IBaseEntityCollectionResponse<SaleContractFixAttendance> GetContractFixAttendanceForApproval(SaleContractFixAttendanceSearchRequest searchRequest)
        {
            ...
            {
                if (_SaleContractFixAttendanceDataProvider != null)
                    SaleContractFixAttendanceCollection = _SaleContractFixAttendanceDataProvider.GetContractFixAttendanceForApproval(searchRequest);
                else
                {
                    SaleContractFixAttendanceCollection.Message.Add(new MessageDTO
                    {
