    ...
    public class SaleContractAttendanceBA : ISaleContractAttendanceBA
    {
        ...
        public IBaseEntityResponse<SaleContractAttendance> InsertContractAttendanceApproval(SaleContractAttendance item)
        {
            ...
            try
            {
                if (_SaleContractAttendanceDataProvider != null)
                {
                    entityResponse = _SaleContractAttendanceDataProvider.InsertContractAttendanceApproval(item);
                }
                else
                {
                    entityResponse.Message.Add(new MessageDTO
        ...
        public IBaseEntityCollectionResponse<SaleContractAttendance> GetContractAttendanceForApproval(SaleContractAttendanceSearchRequest searchRequest)
        {
            ...
            {
                if (_SaleContractAttendanceDataProvider != null)
                    SaleContractAttendanceCollection = _SaleContractAttendanceDataProvider.GetContractAttendanceForApproval(searchRequest);
                else
                {
                    SaleContractAttendanceCollection.Message.Add(new MessageDTO
                    {
