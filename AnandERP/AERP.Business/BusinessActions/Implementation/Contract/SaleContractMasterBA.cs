...
namespace AERP.Business.BusinessAction
{
    public class SaleContractMasterBA : ISaleContractMasterBA
    {
        ...
        public IBaseEntityCollectionResponse<SaleContractMaster> GetContractNumberSearchListAll(SaleContractMasterSearchRequest searchRequest)
        {
            ...
            {
                if (_SaleContractMasterDataProvider != null)
                    SaleContractMasterCollection = _SaleContractMasterDataProvider.GetContractNumberSearchListAll(searchRequest);
                else
                {
                    SaleContractMasterCollection.Message.Add(new MessageDTO
                    {
        ...
        public IBaseEntityCollectionResponse<SaleContractMaster> GetSaleContractForApproval(SaleContractMasterSearchRequest searchRequest)
        {
            ...
            {
                if (_SaleContractMasterDataProvider != null)
                    SaleContractMasterCollection = _SaleContractMasterDataProvider.GetSaleContractForApproval(searchRequest);
                else
                {
                    SaleContractMasterCollection.Message.Add(new MessageDTO
                    {
        ...
        public IBaseEntityResponse<SaleContractMaster> InsertSaleContractApproval(SaleContractMaster item)
        {
            ...
            try
            {
                if (_SaleContractMasterDataProvider != null)
                {
                    entityResponse = _SaleContractMasterDataProvider.InsertSaleContractApproval(item);
                }
                else
                {
                    entityResponse.Message.Add(new MessageDTO
        ...
        public IBaseEntityResponse<SaleContractMaster> GetSaleContractApprovalStatus(SaleContractMaster item)
        {
            ...
            try
            {
                if (_SaleContractMasterDataProvider != null)
                {
                    entityResponse = _SaleContractMasterDataProvider.GetSaleContractApprovalStatus(item);
                }
                else
                {
                    entityResponse.Message.Add(new MessageDTO
