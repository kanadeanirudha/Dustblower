...
namespace AERP.Business.BusinessAction
{
    public class SaleContractManPowerItemBA : ISaleContractManPowerItemBA
    {
        ...
        public IBaseEntityResponse<SaleContractManPowerItem> InsertManPowerItemApproval(SaleContractManPowerItem item)
        {
            ...
            try
            {
                entityResponse = _generalRegionMasterDataProvider.InsertManPowerItemApproval(item);
            }
            catch (Exception ex)
            {
                entityResponse.Message.Add(new MessageDTO
        ...
        public IBaseEntityCollectionResponse<SaleContractManPowerItem> GetManPowerItemForApproval(SaleContractManPowerItemSearchRequest searchRequest)
        {
            ...
            try
            {
                if (_generalRegionMasterDataProvider != null)
                {
                    categoryMasterCollection = _generalRegionMasterDataProvider.GetManPowerItemForApproval(searchRequest);
                }
                else
                {
                    categoryMasterCollection.Message.Add(new MessageDTO
