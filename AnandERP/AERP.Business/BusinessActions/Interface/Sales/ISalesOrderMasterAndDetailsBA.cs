...
namespace AERP.Business.BusinessAction
{
    public interface ISalesOrderMasterAndDetailsBA
    {
        ...
        IBaseEntityResponse<SalesOrderMasterAndDetails> InsertSalesOrderApproval(SalesOrderMasterAndDetails item);
        IBaseEntityCollectionResponse<SalesOrderMasterAndDetails> GetSalesOrderForApproval(SalesOrderMasterAndDetailsSearchRequest searchRequest);
    }
}
