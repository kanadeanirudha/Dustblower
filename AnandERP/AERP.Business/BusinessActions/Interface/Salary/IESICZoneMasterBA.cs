...
namespace AERP.Business.BusinessAction
{
    public interface IESICZoneMasterBA
    {
        ...
        IBaseEntityResponse<ESICZoneMaster> DeleteESICZoneMasterCity(ESICZoneMaster item);
        ...
        IBaseEntityResponse<ESICZoneMaster> InsertESICZoneMasterCity(ESICZoneMaster item); 
    }
}
