...
namespace AERP.ViewModel
{
    ...
    public interface IAccountCategoryMasterBaseViewModel
    {
        List<AccountCategoryMaster> ListAccountCategoryMaster
        {
            get;
            set;
        }
        List<AccountHeadMaster> ListAccountHeadMaster
        {
            get;
            set;
        }
    ...
    public interface IAccountCategoryMasterViewModel
    {
        AccountCategoryMaster AccountCategoryMasterDTO { get; set; }
        Int16 ID 
        { 
            get; 
            set; 
