...
namespace AERP.ViewModel
{
    public class SaleContractSalaryTransactionViewModel : ISaleContractSalaryTransactionViewModel
    {
        ...
        public string CentreCode
        {
            get
            {
                return (SaleContractSalaryTransactionDTO != null) ? SaleContractSalaryTransactionDTO.CentreCode : string.Empty;
            }
            set
            {
                SaleContractSalaryTransactionDTO.CentreCode = value;
            }
        }
