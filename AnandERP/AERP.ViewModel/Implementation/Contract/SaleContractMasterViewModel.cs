...
namespace AERP.ViewModel
{
    public class SaleContractMasterViewModel : ISaleContractMasterViewModel
    {
        ...
        public SaleContractMasterViewModel()
        {
            ...
            SaleContractMasterList = new List<SaleContractMaster>();
        }
        ...
        public List<SaleContractMaster> SaleContractMasterList { get; set; }
        ...
        public int PersonID
        {
            get
            {
                return (SaleContractMasterDTO != null && SaleContractMasterDTO.PersonID > 0) ? SaleContractMasterDTO.PersonID : new int();
            }
            set
            {
                SaleContractMasterDTO.PersonID = value;
            }
        }
        public int TaskNotificationDetailsID
        {
            get
            {
                return (SaleContractMasterDTO != null && SaleContractMasterDTO.TaskNotificationDetailsID > 0) ? SaleContractMasterDTO.TaskNotificationDetailsID : new int();
            }
            set
            {
                SaleContractMasterDTO.TaskNotificationDetailsID = value;
            }
        }
        public int TaskNotificationMasterID
        {
            get
            {
                return (SaleContractMasterDTO != null && SaleContractMasterDTO.TaskNotificationMasterID > 0) ? SaleContractMasterDTO.TaskNotificationMasterID : new int();
            }
            set
            {
                SaleContractMasterDTO.TaskNotificationMasterID = value;
            }
        }
        public int GeneralTaskReportingDetailsID
        {
            get
            {
                return (SaleContractMasterDTO != null && SaleContractMasterDTO.GeneralTaskReportingDetailsID > 0) ? SaleContractMasterDTO.GeneralTaskReportingDetailsID : new int();
            }
            set
            {
                SaleContractMasterDTO.GeneralTaskReportingDetailsID = value;
            }
        }
        public int StageSequenceNumber
        {
            get
            {
                return (SaleContractMasterDTO != null && SaleContractMasterDTO.StageSequenceNumber > 0) ? SaleContractMasterDTO.StageSequenceNumber : new int();
            }
            set
            {
                SaleContractMasterDTO.StageSequenceNumber = value;
            }
        }
        public bool IsLastRecord
        {
            get
            {
                return (SaleContractMasterDTO != null) ? SaleContractMasterDTO.IsLastRecord : new bool();
            }
            set
            {
                SaleContractMasterDTO.IsLastRecord = value;
            }
        }
        public byte ApprovedStatus
        {
            get
            {
                return (SaleContractMasterDTO != null && SaleContractMasterDTO.ApprovedStatus > 0) ? SaleContractMasterDTO.ApprovedStatus : new byte();
            }
            set
            {
                SaleContractMasterDTO.ApprovedStatus = value;
            }
        }
        public byte ApprovalStatus
        {
            get
            {
                return (SaleContractMasterDTO != null && SaleContractMasterDTO.ApprovalStatus > 0) ? SaleContractMasterDTO.ApprovalStatus : new byte();
            }
            set
            {
                SaleContractMasterDTO.ApprovalStatus = value;
            }
        }
    }
}
