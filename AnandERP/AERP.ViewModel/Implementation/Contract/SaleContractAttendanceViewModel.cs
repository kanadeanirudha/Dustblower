...
namespace AERP.ViewModel
{
    public class SaleContractAttendanceViewModel : ISaleContractAttendanceViewModel
    {
        ...
        public string CentreCode
        {
            get
            {
                return (SaleContractAttendanceDTO != null) ? SaleContractAttendanceDTO.CentreCode : string.Empty;
            }
            set
            {
                SaleContractAttendanceDTO.CentreCode = value;
            }
        }
        ...
        public int PersonID
        {
            get
            {
                return (SaleContractAttendanceDTO != null && SaleContractAttendanceDTO.PersonID > 0) ? SaleContractAttendanceDTO.PersonID : new int();
            }
            set
            {
                SaleContractAttendanceDTO.PersonID = value;
            }
        }
        public int TaskNotificationDetailsID
        {
            get
            {
                return (SaleContractAttendanceDTO != null && SaleContractAttendanceDTO.TaskNotificationDetailsID > 0) ? SaleContractAttendanceDTO.TaskNotificationDetailsID : new int();
            }
            set
            {
                SaleContractAttendanceDTO.TaskNotificationDetailsID = value;
            }
        }
        public int TaskNotificationMasterID
        {
            get
            {
                return (SaleContractAttendanceDTO != null && SaleContractAttendanceDTO.TaskNotificationMasterID > 0) ? SaleContractAttendanceDTO.TaskNotificationMasterID : new int();
            }
            set
            {
                SaleContractAttendanceDTO.TaskNotificationMasterID = value;
            }
        }
        public int GeneralTaskReportingDetailsID
        {
            get
            {
                return (SaleContractAttendanceDTO != null && SaleContractAttendanceDTO.GeneralTaskReportingDetailsID > 0) ? SaleContractAttendanceDTO.GeneralTaskReportingDetailsID : new int();
            }
            set
            {
                SaleContractAttendanceDTO.GeneralTaskReportingDetailsID = value;
            }
        }
        public int StageSequenceNumber
        {
            get
            {
                return (SaleContractAttendanceDTO != null && SaleContractAttendanceDTO.StageSequenceNumber > 0) ? SaleContractAttendanceDTO.StageSequenceNumber : new int();
            }
            set
            {
                SaleContractAttendanceDTO.StageSequenceNumber = value;
            }
        }
        public bool IsLastRecord
        {
            get
            {
                return (SaleContractAttendanceDTO != null) ? SaleContractAttendanceDTO.IsLastRecord : new bool();
            }
            set
            {
                SaleContractAttendanceDTO.IsLastRecord = value;
            }
        }
        public byte ApprovedStatus
        {
            get
            {
                return (SaleContractAttendanceDTO != null && SaleContractAttendanceDTO.ApprovedStatus > 0) ? SaleContractAttendanceDTO.ApprovedStatus : new byte();
            }
            set
            {
                SaleContractAttendanceDTO.ApprovedStatus = value;
            }
        }
        public byte ApprovalStatus
        {
            get
            {
                return (SaleContractAttendanceDTO != null && SaleContractAttendanceDTO.ApprovalStatus > 0) ? SaleContractAttendanceDTO.ApprovalStatus : new byte();
            }
            set
            {
                SaleContractAttendanceDTO.ApprovalStatus = value;
            }
        }
        public string TaskCode
        {
            get
            {
                return (SaleContractAttendanceDTO != null) ? SaleContractAttendanceDTO.TaskCode : string.Empty;
            }
            set
            {
                SaleContractAttendanceDTO.TaskCode = value;
            }
        }
    }
}