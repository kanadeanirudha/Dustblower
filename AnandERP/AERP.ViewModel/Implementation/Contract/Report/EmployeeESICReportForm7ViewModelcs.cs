...
namespace AERP.ViewModel
{
    public class EmployeeESICReportForm7ViewModel
    {
        ...
        public int ESICZoneID
        {
            get
            {
                return (EmployeeESICReportForm7 != null && EmployeeESICReportForm7.ESICZoneID > 0) ? EmployeeESICReportForm7.ESICZoneID : new int();
            }
            set
            {
                EmployeeESICReportForm7.ESICZoneID = value;
            }
        }
