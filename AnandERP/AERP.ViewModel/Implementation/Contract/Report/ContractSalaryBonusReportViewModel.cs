...
namespace AERP.ViewModel
{
    public class ContractSalaryBonusReportViewModel
    {
        ...
        public bool ATMReport
        {
            get
            {
                return (ContractSalaryBonusReportDTO != null) ? ContractSalaryBonusReportDTO.ATMReport : false;
            }
            set
            {
                ContractSalaryBonusReportDTO.ATMReport = value;
            }
        }
