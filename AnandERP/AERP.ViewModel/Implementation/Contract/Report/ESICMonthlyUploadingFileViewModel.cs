...
namespace AERP.ViewModel
{
    public class ESICMonthlyUploadingFileViewModel
    {
        ...
        public string errorMessage { get; set; }
            ...
            public Int16 ESICZoneID
        {
            get
            {
                return (ESICMonthlyUploadingFile != null && ESICMonthlyUploadingFile.ESICZoneID > 0) ? ESICMonthlyUploadingFile.ESICZoneID : new Int16();
            }
            set
            {
                ESICMonthlyUploadingFile.ESICZoneID = value;
            }
        }
    }
}
