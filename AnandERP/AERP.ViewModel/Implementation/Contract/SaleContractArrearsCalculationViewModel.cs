...
namespace AERP.ViewModel
{
    public class SaleContractArrearsCalculationViewModel : ISaleContractArrearsCalculationViewModel
    {
        ...
        public string CentreCode
        {
            get
            {
                return (SaleContractArrearsCalculationDTO != null) ? SaleContractArrearsCalculationDTO.CentreCode : string.Empty;
            }
            set
            {
                SaleContractArrearsCalculationDTO.CentreCode = value;
            }
        }
    }
}
