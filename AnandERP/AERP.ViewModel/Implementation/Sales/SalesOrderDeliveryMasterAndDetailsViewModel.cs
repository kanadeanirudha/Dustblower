...
namespace AERP.ViewModel
{
    public class SalesOrderDeliveryMasterAndDetailsViewModel : ISalesOrderDeliveryMasterAndDetailsViewModel
    {
        ...
        public decimal SaleAmountWtGst
        {
            get
            {
                return (SalesOrderDeliveryMasterAndDetailsDTO != null && SalesOrderDeliveryMasterAndDetailsDTO.SaleAmountWtGst > 0) ? SalesOrderDeliveryMasterAndDetailsDTO.SaleAmountWtGst : new decimal();
            }
            set
            {
                SalesOrderDeliveryMasterAndDetailsDTO.SaleAmountWtGst = value;
            }
        }

        public decimal PurchaseCostAmountWTGST
        {
            get
            {
                return (SalesOrderDeliveryMasterAndDetailsDTO != null && SalesOrderDeliveryMasterAndDetailsDTO.PurchaseCostAmountWTGST > 0) ? SalesOrderDeliveryMasterAndDetailsDTO.PurchaseCostAmountWTGST : new decimal();
            }
            set
            {
                SalesOrderDeliveryMasterAndDetailsDTO.PurchaseCostAmountWTGST = value;
            }
        }
        ...
        public string CustomerBranchName
        {
            get
            {
                return (SalesOrderDeliveryMasterAndDetailsDTO != null) ? SalesOrderDeliveryMasterAndDetailsDTO.CustomerBranchName : string.Empty;
            }
            set
            {
                SalesOrderDeliveryMasterAndDetailsDTO.CustomerBranchName = value;
            }
        }
        ...
        public decimal PurchaseAmount
        {
            get
            {
                return (SalesOrderDeliveryMasterAndDetailsDTO != null && SalesOrderDeliveryMasterAndDetailsDTO.PurchaseAmount > 0) ? SalesOrderDeliveryMasterAndDetailsDTO.PurchaseAmount : new decimal();
            }
            set
            {
                SalesOrderDeliveryMasterAndDetailsDTO.PurchaseAmount = value;
            }
        }

        public decimal PurchaseBillAmount
        {
            get
            {
                return (SalesOrderDeliveryMasterAndDetailsDTO != null && SalesOrderDeliveryMasterAndDetailsDTO.PurchaseBillAmount > 0) ? SalesOrderDeliveryMasterAndDetailsDTO.PurchaseBillAmount : new decimal();
            }
            set
            {
                SalesOrderDeliveryMasterAndDetailsDTO.PurchaseBillAmount = value;
            }
        }
    }
}
