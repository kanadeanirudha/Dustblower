...
namespace AERP.ViewModel
{
    public class SalesOrderMasterAndDetailsViewModel : ISalesOrderMasterAndDetailsViewModel
    {
        ...
        public string SalaryMonth
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null) ? SalesOrderMasterAndDetailsDTO.SalaryMonth : string.Empty;
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.SalaryMonth = value;
            }
        }
        [Display(Name = "Year")]
        public string SalaryYear
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null) ? SalesOrderMasterAndDetailsDTO.SalaryYear : string.Empty;
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.SalaryYear = value;
            }
        }
        ...
        public bool IsPosted
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null) ? SalesOrderMasterAndDetailsDTO.IsPosted : false;
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.IsPosted = value;
            }
        }
        ...
        public byte ApprovalStatus
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null) ? SalesOrderMasterAndDetailsDTO.ApprovalStatus : new byte();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.ApprovalStatus = value;
            }
        }
        public string TaskCode
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null) ? SalesOrderMasterAndDetailsDTO.TaskCode : string.Empty;
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.TaskCode = value;
            }
        }
        public int TaskNotificationDetailsID
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null && SalesOrderMasterAndDetailsDTO.TaskNotificationDetailsID > 0) ? SalesOrderMasterAndDetailsDTO.TaskNotificationDetailsID : new int();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.TaskNotificationDetailsID = value;
            }
        }
        public int TaskNotificationMasterID
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null && SalesOrderMasterAndDetailsDTO.TaskNotificationMasterID > 0) ? SalesOrderMasterAndDetailsDTO.TaskNotificationMasterID : new int();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.TaskNotificationMasterID = value;
            }
        }
        public int GeneralTaskReportingDetailsID
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null && SalesOrderMasterAndDetailsDTO.GeneralTaskReportingDetailsID > 0) ? SalesOrderMasterAndDetailsDTO.GeneralTaskReportingDetailsID : new int();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.GeneralTaskReportingDetailsID = value;
            }
        }
        public int PersonID
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null && SalesOrderMasterAndDetailsDTO.PersonID > 0) ? SalesOrderMasterAndDetailsDTO.PersonID : new int();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.PersonID = value;
            }
        }
        public int StageSequenceNumber
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null && SalesOrderMasterAndDetailsDTO.StageSequenceNumber > 0) ? SalesOrderMasterAndDetailsDTO.StageSequenceNumber : new int();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.StageSequenceNumber = value;
            }
        }
        public bool IsLastRecord
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null) ? SalesOrderMasterAndDetailsDTO.IsLastRecord : new bool();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.IsLastRecord = value;
            }
        }
        public byte ApprovedStatus
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null) ? SalesOrderMasterAndDetailsDTO.ApprovedStatus : new byte();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.ApprovedStatus = value;
            }
        }
        public int ID
        {
            get
            {
                return (SalesOrderMasterAndDetailsDTO != null && SalesOrderMasterAndDetailsDTO.ID > 0) ? SalesOrderMasterAndDetailsDTO.ID : new int();
            }
            set
            {
                SalesOrderMasterAndDetailsDTO.ID = value;
            }
        }
    }
}
