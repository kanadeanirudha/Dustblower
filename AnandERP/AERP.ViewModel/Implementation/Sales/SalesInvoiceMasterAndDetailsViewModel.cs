...
namespace AERP.ViewModel
{
    public class SalesInvoiceMasterAndDetailsViewModel : ISalesInvoiceMasterAndDetailsViewModel
    {
        ...
        public byte ApprovalStatus
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null) ? SalesInvoiceMasterAndDetailsDTO.ApprovalStatus : new byte();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.ApprovalStatus = value;
            }
        }
        public byte CancelApprovalStatus
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null) ? SalesInvoiceMasterAndDetailsDTO.CancelApprovalStatus : new byte();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.CancelApprovalStatus = value;
            }
        }
        public string TaskCode
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null) ? SalesInvoiceMasterAndDetailsDTO.TaskCode : string.Empty;
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.TaskCode = value;
            }
        }
        public int TaskNotificationDetailsID
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null && SalesInvoiceMasterAndDetailsDTO.TaskNotificationDetailsID > 0) ? SalesInvoiceMasterAndDetailsDTO.TaskNotificationDetailsID : new int();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.TaskNotificationDetailsID = value;
            }
        }
        public int TaskNotificationMasterID
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null && SalesInvoiceMasterAndDetailsDTO.TaskNotificationMasterID > 0) ? SalesInvoiceMasterAndDetailsDTO.TaskNotificationMasterID : new int();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.TaskNotificationMasterID = value;
            }
        }
        public int GeneralTaskReportingDetailsID
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null && SalesInvoiceMasterAndDetailsDTO.GeneralTaskReportingDetailsID > 0) ? SalesInvoiceMasterAndDetailsDTO.GeneralTaskReportingDetailsID : new int();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.GeneralTaskReportingDetailsID = value;
            }
        }
        public int PersonID
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null && SalesInvoiceMasterAndDetailsDTO.PersonID > 0) ? SalesInvoiceMasterAndDetailsDTO.PersonID : new int();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.PersonID = value;
            }
        }
        public int StageSequenceNumber
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null && SalesInvoiceMasterAndDetailsDTO.StageSequenceNumber > 0) ? SalesInvoiceMasterAndDetailsDTO.StageSequenceNumber : new int();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.StageSequenceNumber = value;
            }
        }
        public bool IsLastRecord
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null) ? SalesInvoiceMasterAndDetailsDTO.IsLastRecord : new bool();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.IsLastRecord = value;
            }
        }
        public byte ApprovedStatus
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null) ? SalesInvoiceMasterAndDetailsDTO.ApprovedStatus : new byte();
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.ApprovedStatus = value;
            }
        }
        [Display(Name = "Month")]
        public string MonthName
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null) ? SalesInvoiceMasterAndDetailsDTO.MonthName : string.Empty;
            }
            set
            {
                SalesInvoiceMasterAndDetailsDTO.MonthName = value;
            }
        }
        [Display(Name = "Year")]
        public string MonthYear
        {
            get
            {
                return (SalesInvoiceMasterAndDetailsDTO != null) ? SalesInvoiceMasterAndDetailsDTO.MonthYear : string.Empty;
            }
            set
            {
