...
namespace AERP.ViewModel
{
  ...
  [Display(Name = "Is Default")]
        ...
        public Int16 ESICZoneDetailsID
        {
            get
            {
                return (ESICZoneMasterDTO != null && ESICZoneMasterDTO.ESICZoneDetailsID > 0) ? ESICZoneMasterDTO.ESICZoneDetailsID : new Int16();
            }
            set
            {
                ESICZoneMasterDTO.ESICZoneDetailsID = value;
            }
        }
        ...
        public string CityName
        {
            get
            {
                return (ESICZoneMasterDTO != null) ? ESICZoneMasterDTO.CityName : string.Empty;
            }
            set
            {
                ESICZoneMasterDTO.CityName = value;
            }
        }
        public Int32 CityID
        {
            get
            {
                return (ESICZoneMasterDTO != null && ESICZoneMasterDTO.CityID > 0) ? ESICZoneMasterDTO.CityID : new Int32();
            }
            set
            {
                ESICZoneMasterDTO.CityID = value;
            }
        }
    }
}
