...
namespace AERP.ViewModel
{
    public class TaskNotificationViewModel
    {
        ...
        public string CompanyName
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.CompanyName : string.Empty;
            }
            set
            {
                TaskNotificationDTO.CompanyName = value;
            }
        }
        ...
        public string Designation
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.Designation : string.Empty;
            }
            set
            {
                TaskNotificationDTO.Designation = value;
            }
        }
        ...
        public string TotalAmount
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.TotalAmount : string.Empty;
            }
            set
            {
                TaskNotificationDTO.TotalAmount = value;
            }
        }
        ...
        public string ContractNumber
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.ContractNumber : string.Empty;
            }
            set
            {
                TaskNotificationDTO.ContractNumber = value;
            }
        }
        ...
        public string BillingType
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.BillingType : string.Empty;
            }
            set
            {
                TaskNotificationDTO.BillingType = value;
            }
        }

        public string SaleContractBillingSpan
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.SaleContractBillingSpan : string.Empty;
            }
            set
            {
                TaskNotificationDTO.SaleContractBillingSpan = value;
            }
        }
        public string SalesOrderNumber
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.SalesOrderNumber : string.Empty;
            }
            set
            {
                TaskNotificationDTO.SalesOrderNumber = value;
            }
        }
        public string CustomerInvoiceNumber
        {
            get
            {
                return (TaskNotificationDTO != null) ? TaskNotificationDTO.CustomerInvoiceNumber : string.Empty;
            }
            set
            {
                TaskNotificationDTO.CustomerInvoiceNumber = value;
            }
        }
        ...
        public Int32 EmployeeID
        {
            get
            {
                return (TaskNotificationDTO != null && TaskNotificationDTO.EmployeeID > 0) ? TaskNotificationDTO.EmployeeID : new Int32();
            }
            set
            {
                TaskNotificationDTO.EmployeeID = value;
            }
        }
        public Int32 NotificationCount
        {
            get
            {
                return (TaskNotificationDTO != null && TaskNotificationDTO.NotificationCount > 0) ? TaskNotificationDTO.NotificationCount : new Int32();
            }
            set
            {
