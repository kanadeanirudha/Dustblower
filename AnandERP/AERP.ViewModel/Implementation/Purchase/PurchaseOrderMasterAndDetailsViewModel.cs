...
namespace AERP.ViewModel
{
    public class PurchaseOrderMasterAndDetailsViewModel : IPurchaseOrderMasterAndDetailsViewModel
    {
        ...
        [Display(Name = "Purchase Order From Date")]
        public string PurchaseOrderFromDate
        {
            get
            {
                return (PurchaseOrderMasterAndDetailsDTO != null) ? PurchaseOrderMasterAndDetailsDTO.PurchaseOrderFromDate : string.Empty;
            }
            set
            {
                PurchaseOrderMasterAndDetailsDTO.PurchaseOrderFromDate = value;
            }
        }

        [Display(Name = "Purchase Order Upto Date")]
        public string PurchaseOrderUptoDate
        {
            get
            {
                return (PurchaseOrderMasterAndDetailsDTO != null) ? PurchaseOrderMasterAndDetailsDTO.PurchaseOrderUptoDate : string.Empty;
            }
            set
            {
                PurchaseOrderMasterAndDetailsDTO.PurchaseOrderUptoDate = value;
            }
        }
