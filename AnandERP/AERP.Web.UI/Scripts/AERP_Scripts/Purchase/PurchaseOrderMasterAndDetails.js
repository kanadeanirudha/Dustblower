...
var PurchaseOrderMasterAndDetails = {
    ...
    constructor: function () {
        ...
        $("#btnShowList").unbind("click").on("click", function () {
            PurchaseOrderMasterAndDetails.LoadListByPurchaseOrderType($('#PurchaseOrderType :selected').val(), $('#PurchaseOrderFromDate').val(), $('#PurchaseOrderUptoDate').val());
        });
        // Create new record
    ...
    LoadListByPurchaseOrderType: function (PurchaseOrderType, PurchaseOrderFromDate, PurchaseOrderUptoDate) {
        debugger;
             $.ajax(
          {
              cache: false,
              type: "POST",
              data: { PurchaseOrderType: PurchaseOrderType, PurchaseOrderFromDate: PurchaseOrderFromDate, PurchaseOrderUptoDate: PurchaseOrderUptoDate },
              dataType: "html",
              url: '/PurchaseOrderMasterAndDetails/List',
