...
var EmployeeDashboard = {
    ...
    constructor: function () {
        ...
        $('ul#TaskList li').click(function () {
            ...
            if (TaskCode == "PO") {
                ...
                Newurl = '/TaskNotification/ManPowerItemPendingRequest';
            }
            else if (TaskCode == "SC") {
                Newurl = '/TaskNotification/SaleContractPendingRequest';
            }
            else if (TaskCode == "CA") {
                Newurl = '/TaskNotification/ContractAttendancePendingRequest';
            }
            else if (TaskCode == "CF") {
                Newurl = '/TaskNotification/ContractFixAttendancePendingRequest';
            }
            else if (TaskCode == "SI") {
                Newurl = '/TaskNotification/SalesInvoicePendingRequest';
            }
            else if (TaskCode == "CI") {
                Newurl = '/TaskNotification/CancelSalesInvoicePendingRequest';
            }
            else if (TaskCode == "CSR") {
                Newurl = '/TaskNotification/CustomerSaleRatePendingRequest';
            }
            else if (TaskCode == "CSD") {
                Newurl = '/TaskNotification/CustomerSaleRateDeletePendingRequest';
            }
            $.ajax(
                  {
                      cache: false,
    ...
    AjaxCallEmployeeDashboard: function () {
        ...
        if (EmployeeDashboard.ActionName == "Create") {
            ...
            EmployeeDashboardData = null;
            EmployeeDashboardData = EmployeeDashboard.GetEmployeeDashboard();
            ajaxRequest.makeRequest("/Home/ApproveAllV2", "POST", EmployeeDashboardData, EmployeeDashboard.Success);
        }
    },
