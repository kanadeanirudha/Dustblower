...
var ESICZoneMaster = {
    ...
    constructor: function () {
        ...
        $('#CreateESICZoneMasterCityRecord').on("click", function () {

            ESICZoneMaster.ActionName = "CreateCity";
            ESICZoneMaster.AjaxCallESICZoneMaster();
        });
    ...
    AjaxCallESICZoneMaster: function () {
        ...
        else if (ESICZoneMaster.ActionName == "CreateCity") {

            $("#FormCreateESICZoneMaster").validate();

            ESICZoneMasterData = null;
            ESICZoneMasterData = ESICZoneMaster.GetESICZoneMaster();
            ajaxRequest.makeRequest("/ESICZoneMaster/CreateESICZoneMasterCity", "POST", ESICZoneMasterData, ESICZoneMaster.Success, "CreateESICZoneMasterCityRecord");
