...
var ESICMonthlyUploadingFile = {
    ...
    constructor: function () {
        ...
        $("#btnShowDetails").unbind('click').click(function () {
            ...
            if ((MonthName > 0) && (MonthYear > 0) && CentreCode != "") {
                debugger;
                $("#UploadFile").show(true);
                $("#UploadFilelink").attr("href", "ESICMonthlyUploadingFile/DownloadExcel?MonthName=" + MonthName + "&MonthYear=" + MonthYear + "&ESICZoneID=" + ESICZoneID + "&CentreCode=" + CentreCode)
