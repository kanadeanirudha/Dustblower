...
var SaleContractSalaryTransaction = {
    ...
    GetXmlDataForBulkSalaryTransaction: function () {
        ...
        $(".EmployeeMasterID").each(function () {
            ...
            ParameterXml = ParameterXml + "<row><EmpID>" + EmployeeMasterID + "</EmpID><ManPowerID>" + ManPowerItemID + "</ManPowerID><AdjTotalAtt>" + AdjustedTotalAttendance + "</AdjTotalAtt><ActTotalAtt>" + ActualTotalAttendance + "</ActTotalAtt><RemoveForAdj>" + RemoveForAdjustment + "</RemoveForAdj><BasicAmt>" + ActualBasicAmount + "</BasicAmt><TotalAmt>" + TotalAmount + "</TotalAmt><GrossAmt>" + GrossAmount + "</GrossAmt><TotalDed>" + TotalDeduction + "</TotalDed><NetPay>" + NetPayable + "</NetPay><EmprContriTot>" + EmployerContributionTotal + "</EmprContriTot><TotalSal>" + TotalSalary + "</TotalSal><AdjTotalSal>" + AdjustedTotalSalary + "</AdjTotalSal><AdjBasicAmt>" + AdjustedBasicAmount + "</AdjBasicAmt><TotalEarn>" + TotalEarnings + "</TotalEarn><AdjNetPay>" + AdjustedNetPayable + "</AdjNetPay></row>";
            ...
            $(this).closest("tr").find('td input.ActualTransAmount').each(function () {
                ...
                ParameterXmlTrans = ParameterXmlTrans + "<row><EmpID>" + EmployeeMasterID + "</EmpID><Amount>" + ActualTransAmount + "</Amount><ManPowerAllowanceID>" + ActualTransAllowanceID + "</ManPowerAllowanceID><ManPowerDeductionID>" + ActualTransDeductionID + "</ManPowerDeductionID><IsAllowance>" + ActualTransIsAllowance + "</IsAllowance><AdjustedAmt>" + AdjustedAmount + "</AdjustedAmt><ManPowerID>" + ManPowerItemID + "</ManPowerID></row>";
            });
        });
