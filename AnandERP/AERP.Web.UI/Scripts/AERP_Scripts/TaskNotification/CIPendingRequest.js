...
var CIPendingRequest = {
    ...
    Initialize: function () {
        ...
        CIPendingRequest.constructor();
        //CIPendingRequest.initializeValidation();
    },
    //Attach all event of page
    constructor: function () {
        // Create new record

        $('#CreateApprovedCancelSalesInvoiceMaster').on("click", function () {
            CIPendingRequest.ActionName = "Approved";
            CIPendingRequest.AjaxCallCIPendingRequest();
        });
    },
    ...
    AjaxCallCIPendingRequest: function () {
        var CIPendingRequestData = null;
        if (CIPendingRequest.ActionName == "Approved") {
            CIPendingRequestData = null;
            CIPendingRequestData = CIPendingRequest.GetCIPendingRequest();
            ajaxRequest.makeRequest("/SalesInvoiceMasterAndDetails/CancelSalesInvoiceApproval", "POST", CIPendingRequestData, CIPendingRequest.Success);
        }
    },
    //Get properties data from the Create, Update and Delete page
    GetCIPendingRequest: function () {
        var Data = {
        };
        
        if (CIPendingRequest.ActionName == "Approved" || CIPendingRequest.ActionName == "Rejected") {
            Data.ID = $('#ID').val();
    ...
    Success: function (data) {
        ...
        CIPendingRequest.ReloadList(splitData[0], splitData[1], splitData[2]);
    ...
    //            }
    //            else if (CIPendingRequest.ActionName == "Rejected") {
    ...
    //    CIPendingRequest.XMLstring = ParameterXml + "</rows>";
