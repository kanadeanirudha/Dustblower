...
var CSDPendingRequest = {
    ...
    Initialize: function () {
        ...
        CSDPendingRequest.constructor();
        //CSDPendingRequest.initializeValidation();
    },
    //Attach all event of page
    constructor: function () {
        // Create new record

        $('#CreateApprovedCustomerSaleRateDelete').on("click", function () {
            CSDPendingRequest.ActionName = "Approved";
            CSDPendingRequest.AjaxCallCSDPendingRequest();
        });
    },
    ...
    AjaxCallCSDPendingRequest: function () {
        var CSDPendingRequestData = null;
        if (CSDPendingRequest.ActionName == "Approved") {
            CSDPendingRequestData = null;
            CSDPendingRequestData = CSDPendingRequest.GetCSDPendingRequest();
            ajaxRequest.makeRequest("/GeneralItemMaster/CustomerSaleRateDeleteApproval", "POST", CSDPendingRequestData, CSDPendingRequest.Success);
        }
    },
    //Get properties data from the Create, Update and Delete page
    GetCSDPendingRequest: function () {
        var Data = {
        };
        
        if (CSDPendingRequest.ActionName == "Approved" || CSDPendingRequest.ActionName == "Rejected") {
            Data.InventoryItemCodeUnitLevelCustomerSpecificInfoID = $('#InventoryItemCodeUnitLevelCustomerSpecificInfoID').val();
    ...
    Success: function (data) {
        ...
        CSDPendingRequest.ReloadList(splitData[0], splitData[1], splitData[2]);
    ...
    //            }
    //            else if (CSDPendingRequest.ActionName == "Rejected") {
    ...
    //    CSDPendingRequest.XMLstring = ParameterXml + "</rows>";
