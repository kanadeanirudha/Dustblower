...
var SIPendingRequest = {
    ...
    Initialize: function () {
        ...
        SIPendingRequest.constructor();
        //SIPendingRequest.initializeValidation();
    },
    //Attach all event of page
    constructor: function () {
        // Create new record

        $('#CreateApprovedSalesInvoiceMaster').on("click", function () {
            SIPendingRequest.ActionName = "Approved";
            SIPendingRequest.AjaxCallSIPendingRequest();
        });
    },
    ...
    AjaxCallSIPendingRequest: function () {
        var SIPendingRequestData = null;
        if (SIPendingRequest.ActionName == "Approved") {
            SIPendingRequestData = null;
            SIPendingRequestData = SIPendingRequest.GetSIPendingRequest();
            ajaxRequest.makeRequest("/SalesInvoiceMasterAndDetails/SalesInvoiceApproval", "POST", SIPendingRequestData, SIPendingRequest.Success);
        }
    },
    //Get properties data from the Create, Update and Delete page
    GetSIPendingRequest: function () {
        var Data = {
        };
        
        if (SIPendingRequest.ActionName == "Approved" || SIPendingRequest.ActionName == "Rejected") {
            Data.ID = $('#ID').val();
    ...
    Success: function (data) {
        ...
        SIPendingRequest.ReloadList(splitData[0], splitData[1], splitData[2]);
    ...
    //            }
    //            else if (SIPendingRequest.ActionName == "Rejected") {
    ...
    //    SIPendingRequest.XMLstring = ParameterXml + "</rows>";
