...
var CSRPendingRequest = {
    ...
    Initialize: function () {
        ...
        CSRPendingRequest.constructor();
        //CSRPendingRequest.initializeValidation();
    },
    //Attach all event of page
    constructor: function () {
        // Create new record

        $('#CreateApprovedCustomerSaleRate').on("click", function () {
            CSRPendingRequest.ActionName = "Approved";
            CSRPendingRequest.AjaxCallCSRPendingRequest();
        });
    },
    ...
    AjaxCallCSRPendingRequest: function () {
        var CSRPendingRequestData = null;
        if (CSRPendingRequest.ActionName == "Approved") {
            CSRPendingRequestData = null;
            CSRPendingRequestData = CSRPendingRequest.GetCSRPendingRequest();
            ajaxRequest.makeRequest("/GeneralItemMaster/CustomerSaleRateApproval", "POST", CSRPendingRequestData, CSRPendingRequest.Success);
        }
    },
    //Get properties data from the Create, Update and Delete page
    GetCSRPendingRequest: function () {
        var Data = {
        };

        if (CSRPendingRequest.ActionName == "Approved" || CSRPendingRequest.ActionName == "Rejected") {
    ...
    Success: function (data) {
        ...
        CSRPendingRequest.ReloadList(splitData[0], splitData[1], splitData[2]);
    ...
    //            }
    //            else if (CSRPendingRequest.ActionName == "Rejected") {
    ...
    //    CSRPendingRequest.XMLstring = ParameterXml + "</rows>";
