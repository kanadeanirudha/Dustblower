...
var CAPendingRequest = {
    ...
    Initialize: function () {
        ...
        CAPendingRequest.constructor();
        //CAPendingRequest.initializeValidation();
    },
    //Attach all event of page
    constructor: function () {
        // Create new record

        $('#CreateApprovedContractAttendance').on("click", function () {
            CAPendingRequest.ActionName = "Approved";
            CAPendingRequest.AjaxCallCAPendingRequest();
        });
    },
    ...
    AjaxCallCAPendingRequest: function () {
        var CAPendingRequestData = null;
        if (CAPendingRequest.ActionName == "Approved") {
            CAPendingRequestData = null;
            CAPendingRequestData = CAPendingRequest.GetCAPendingRequest();
            ajaxRequest.makeRequest("/SaleContractAttendance/ContractAttendanceApproval", "POST", CAPendingRequestData, CAPendingRequest.Success);
        }
    },
    //Get properties data from the Create, Update and Delete page
    GetCAPendingRequest: function () {
        var Data = {
        };
        
        if (CAPendingRequest.ActionName == "Approved" || CAPendingRequest.ActionName == "Rejected") {
            Data.ID = $('#ID').val();
    ...
    Success: function (data) {
        ...
        CAPendingRequest.ReloadList(splitData[0], splitData[1], splitData[2]);
    ...
    //            }
    //            else if (CAPendingRequest.ActionName == "Rejected") {
    ...
    //    CAPendingRequest.XMLstring = ParameterXml + "</rows>";
