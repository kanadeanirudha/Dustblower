        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    param[1] = new ReportParameter("PurchaseDate", MachineTransactionReport.Count > 0 ? (MachineTransactionReport[0].PurchaseDate != string.Empty && MachineTransactionReport[0].PurchaseDate != "" ? MachineTransactionReport[0].PurchaseDate : "NA") : string.Empty, false);
