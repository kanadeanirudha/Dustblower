      ...
      void Page_Load(object sender, EventArgs e)
      {
          ...
          if (!IsPostBack)
          {
              ...
              else
              {
                  ...
                  rvRetailReports.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory_1/RetailReportDaily.rdlc");
                  ...
                  param[0] = new ReportParameter("DateFrom", RetailReports.Count > 0 ? RetailReports[0].DateFrom : string.Empty, false);
                  param[1] = new ReportParameter("DateTo", RetailReports.Count > 0 ? RetailReports[0].DateTo : string.Empty, false);
                  param[2] = new ReportParameter("CentreName", RetailReports.Count > 0 ? RetailReports[0].CentreName : string.Empty, false);
                  param[3] = new ReportParameter("GeneralUnitsName", RetailReports.Count > 0 ? RetailReports[0].GeneralUnitsName : string.Empty, false);
                  param[4] = new ReportParameter("GranularityName", RetailReports.Count > 0 ? RetailReports[0].GranularityName : string.Empty, false);
        ...
        <div id="MainDiv" runat="server">
            <div id="categoryPrint">
                ...
                <rsweb:ReportViewer ID="rvRetailReports" runat="server" AsyncRendering="false" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.Inventory_1.RetailReportDaily.rdlc">
                        <DataSources>
