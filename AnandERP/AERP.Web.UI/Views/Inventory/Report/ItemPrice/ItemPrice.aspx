...
<head runat="server">
    ...
    <script runat="server">
        ...
        AERP.Web.UI.Controllers.ItemPriceController controller = new AERP.Web.UI.Controllers.ItemPriceController();
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    rvItemPrice.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory/ItemPrice.rdlc");
        ...
        <div id="MainDiv" runat="server">
            <div id="categoryPrint">
                ...
                <rsweb:ReportViewer ID="rvItemPrice" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AERP.Web.UI.Report.Inventory.ItemPrice.rdlc">
                        <DataSources>
