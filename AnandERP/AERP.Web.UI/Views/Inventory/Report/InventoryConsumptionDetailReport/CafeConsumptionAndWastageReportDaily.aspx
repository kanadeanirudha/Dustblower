...
<head runat="server">
 ...
 AMS.Web.UI.Controllers.InventoryConsumptionDetailReportController controller = new AMS.Web.UI.Controllers.InventoryConsumptionDetailReportController();
      ...
      void Page_Load(object sender, EventArgs e)
      {
          ...
          scriptManager.RegisterPostBackControl(this.rvInventoryConsumptionDetailReportDaily);
          if (!IsPostBack)
          {
              rvInventoryConsumptionDetailReportDaily.ProcessingMode = ProcessingMode.Local;
              ...
              else
              {
                  ...
                  rvInventoryConsumptionDetailReportDaily.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory_1/CafeConsumptionAndWastageReportDaily.rdlc");
                  rvInventoryConsumptionDetailReportDaily.LocalReport.DataSources.Clear();

                  ReportDataSource rdc = new ReportDataSource();
                  rdc.Name = "InventoryConsumptionDetailDataSet";
                  rdc.Value = RetailReports;
                  rvInventoryConsumptionDetailReportDaily.LocalReport.DataSources.Clear();
                  rvInventoryConsumptionDetailReportDaily.LocalReport.DataSources.Add(rdc);
                  ...
                  rvInventoryConsumptionDetailReportDaily.LocalReport.SetParameters(param);
                  rvInventoryConsumptionDetailReportDaily.Visible = true;
    ...
    <form runat="server">
        <div id="MainDiv" runat="server">
            <div id="categoryPrint">
                ...
                <rsweb:ReportViewer ID="rvInventoryConsumptionDetailReportDaily" runat="server" AsyncRendering="false" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.Inventory_1.CafeConsumptionAndWastageReportDaily.rdlc">
                        <DataSources>
