...
<head id="Head1" runat="server">
  ...
  <script runat="server">
      ...
      void Page_Load(object sender, EventArgs e)
      {
          ...
          scriptManager.RegisterPostBackControl(this.rvInventoryConsumptionDetailReportMonthly);
          if (!IsPostBack)
          {
              rvInventoryConsumptionDetailReportMonthly.ProcessingMode = ProcessingMode.Local;
              ...
              else
              {
                  ...
                  rvInventoryConsumptionDetailReportMonthly.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory_1/CafeConsumptionAndWastageReportMonthly.rdlc");
                  rvInventoryConsumptionDetailReportMonthly.LocalReport.DataSources.Clear();

                  ReportDataSource rdc = new ReportDataSource();
                  rdc.Name = "InventoryConsumptionDetailDataSet";
                  rdc.Value = RetailReports;
                  rvInventoryConsumptionDetailReportMonthly.LocalReport.DataSources.Clear();
                  rvInventoryConsumptionDetailReportMonthly.LocalReport.DataSources.Add(rdc);
                  ...
                  rvInventoryConsumptionDetailReportMonthly.LocalReport.SetParameters(param);
                  rvInventoryConsumptionDetailReportMonthly.Visible = true;
    ...
    <form id="Form1" runat="server">
        <div id="MainDiv" runat="server">
            <div id="categoryPrint">
                ...
                <rsweb:ReportViewer ID="rvInventoryConsumptionDetailReportMonthly" runat="server" AsyncRendering="false" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.Inventory_1.CafeConsumptionAndWastageReportMonthly.rdlc">
                        <DataSources>
