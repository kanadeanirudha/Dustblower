...
<head runat="server">
    ...
    <title>Account Head Report</title>
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AERP.DTO.AccountHeadMasterReport> accountHeadMasterReport = null;
                List<AERP.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;

                AERP.Web.UI.Controllers.AccountHeadMasterReportController controller = new AERP.Web.UI.Controllers.AccountHeadMasterReportController();
        ...
        <div id="MainDiv" runat="server">
            <div>
                ...
                <rsweb:ReportViewer ID="rvAccountHeadList" runat="server" AsyncRendering="False" SizeToReportContent="True" Font-Names="Verdana" Width="67%" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                    <LocalReport ReportEmbeddedResource="AERP.Web.UI.Report.AccountHeadListReport.rdlc">

                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSetAccountHeadMasterReport" />
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AERPDataSetTableAdapters.USP_AccountHeadMaster_ReportTableAdapter"></asp:ObjectDataSource>
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetData" TypeName="AERPDataSetTableAdapters.TBL_CentrePrintingFormatReportTableAdapter"></asp:ObjectDataSource>
