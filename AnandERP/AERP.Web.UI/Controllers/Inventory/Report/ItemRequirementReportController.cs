...
{
    public class ItemRequirementReportController : BaseController
    {
        ...
        public ItemRequirementReportController()
        {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory/Report/ItemRequirementReport/Index.cshtml", model);
        }
        ...
        public List<InventoryReport> GetItemRequirementReportList()
        {
            try
            {
                ...
                if (_centreCode != string.Empty && _GeneralItemMasterID != 0)
                {
                    ...
                    IBaseEntityCollectionResponse<InventoryReport> baseEntityCollectionResponse = _InventoryReportBA.GetItemRequirementReportList(searchRequest);
