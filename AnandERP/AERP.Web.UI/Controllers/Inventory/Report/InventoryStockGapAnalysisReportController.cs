...
{
    public class InventoryStockGapAnalysisReportController : BaseController
    {
        ...
        public InventoryStockGapAnalysisReportController()
        {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/Report/InventoryStockGapAnalysisReport/Index.cshtml", model);
        }
        [HttpPost]
        ...
        public List<RetailReports> GetInventoryStockGapAnalysisReportList()
        {
            try
            {
                ...
                if (_generalUnitsID > 0)
                {
                    ...
                    IBaseEntityCollectionResponse<RetailReports> baseEntityCollectionResponse = _RetailReportsServiceAccess.GetInventoryStockGapAnalysisReportBySearch(searchRequest);
                    if (baseEntityCollectionResponse != null)
                    {
                        if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                        {
