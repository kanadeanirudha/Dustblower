...
{
    public class InventorySalesAndPurchaseReportController : BaseController
    {
        ...
        public InventorySalesAndPurchaseReportController()
        {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/Report/InventorySalesAndPurchaseReport/Index.cshtml", model);
        }
        [HttpPost]
        ...
        public List<RetailReports> GetnventorySalesAndPurchaseReportList()
        {
            try
            {
                ...
                if (_centreCode != string.Empty)
                {
                    ...
                    IBaseEntityCollectionResponse<RetailReports> baseEntityCollectionResponse = _RetailReportsServiceAccess.GetVendorWiseSaleAndPurchaseReport(searchRequest);
                    if (baseEntityCollectionResponse != null)
                    {
                        if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                        {
