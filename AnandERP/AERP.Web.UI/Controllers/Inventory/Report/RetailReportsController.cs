...
{
    public class RetailReportsController : BaseController
    {
        ...
        public RetailReportsController()
        {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/Report/RetailReports/Index.cshtml", model);
        }
        ...
        public List<RetailReports> GetItemPriceList()
        {
            try
            {
                ...
                if (_generalUnitsID > 0 && _dateFrom != string.Empty && _dateTo != string.Empty && _granularity != string.Empty)
                {
                    ...
                    IBaseEntityCollectionResponse<RetailReports> baseEntityCollectionResponse = _RetailReportsServiceAccess.GetRetailReportsBySearch(searchRequest);
                    if (baseEntityCollectionResponse != null)
                    {
                        if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                        {
