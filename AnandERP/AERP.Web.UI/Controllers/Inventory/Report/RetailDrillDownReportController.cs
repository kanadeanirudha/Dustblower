...
{
    public class RetailDrillDownReportController : BaseController
    {
        #region ------------CONTROLLER CLASS VARIABLE------------
        private string _connectioString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
        IRetailDrillDownReportServiceAccess _RetailDrillDownReportServiceAccess = null;
        ...
        public RetailDrillDownReportController()
        {
            _RetailDrillDownReportServiceAccess = new RetailDrillDownReportServiceAccess();
        ...
        {
            RetailDrillDownReportViewModel model = new RetailDrillDownReportViewModel();
            ...
            return View("/Views/Inventory_1/Report/RetailDrillDownReport/Index.cshtml", model);
        }
        [HttpPost]
        public ActionResult Index(RetailDrillDownReportViewModel model)
        {
            try
            {
        ...
        #region ------------CONTROLLER NON ACTION METHODS------------
         ...
         public List<RetailDrillDownReport> GetStoreList()
         {
             try
             {
                 List<RetailDrillDownReport> listRetailDrillDownReport = new List<RetailDrillDownReport>();
                 RetailDrillDownReportSearchRequest searchRequest = new RetailDrillDownReportSearchRequest();
                 ...
                 if (_dateFrom != null && _dateTo != null)
                 {
                     ...
                     IBaseEntityCollectionResponse<RetailDrillDownReport> baseEntityCollectionResponse = _RetailDrillDownReportServiceAccess.GetStoresReportBySearch(searchRequest);
                     if (baseEntityCollectionResponse != null)
                     {
                         if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                         {
                             listRetailDrillDownReport = baseEntityCollectionResponse.CollectionResponse.ToList();
                         }
                     }
                 }
                 return listRetailDrillDownReport;
             }
             catch (Exception ex)
             {
                 _logException.Error(ex.Message);
        ...
        public List<RetailDrillDownReport> GetGroupDescriptionList(string GeneralUnitsId,string GeneralUnitsName)
        {
            try
            {
                List<RetailDrillDownReport> listRetailDrillDownReport = new List<RetailDrillDownReport>();
                ...
                if (_dateFrom != null && _dateTo != null)
                {
                    ...
                    IBaseEntityCollectionResponse<RetailDrillDownReport> baseEntityCollectionResponse = _RetailDrillDownReportServiceAccess.GetGroupDescriptionReportBySearch(searchRequest);
                    if (baseEntityCollectionResponse != null)
                    {
                        if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                        {
        ...
        public List<RetailDrillDownReport> GetMerchantiseDepartmentList(string MarchandiseGroupCode)
        {
            try
            {
                List<RetailDrillDownReport> listRetailDrillDownReport = new List<RetailDrillDownReport>();
                ...
                IBaseEntityCollectionResponse<RetailDrillDownReport> baseEntityCollectionResponse = _RetailDrillDownReportServiceAccess.GetMerchantiseDepartmentReportBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
        ...
        public List<RetailDrillDownReport> GetMerchantiseCategoryList(string MerchantiseDepartmentCode)
        {
            try
            {
                List<RetailDrillDownReport> listRetailDrillDownReport = new List<RetailDrillDownReport>();
                ...
                searchRequest.GeneralUnitsName = _generalUnitsName;
                searchRequest.CentreName = _centreName;
                IBaseEntityCollectionResponse<RetailDrillDownReport> baseEntityCollectionResponse = _RetailDrillDownReportServiceAccess.GetMerchantiseCategoryReportBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
        ...
        public List<RetailDrillDownReport> GetMerchantiseSubCategoryList(string MerchantiseCategoryCode)
        {
            try
            {
                List<RetailDrillDownReport> listRetailDrillDownReport = new List<RetailDrillDownReport>();
                ...
                searchRequest.GeneralUnitsName = _generalUnitsName;
                searchRequest.CentreName = _centreName;
                IBaseEntityCollectionResponse<RetailDrillDownReport> baseEntityCollectionResponse = _RetailDrillDownReportServiceAccess.GetMerchantiseSubCategoryReportBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
        ...
        public List<RetailDrillDownReport> GetMerchantiseBaseCategoryList(string MarchandiseSubCatgoryCode)
        {
            try
            {
                List<RetailDrillDownReport> listRetailDrillDownReport = new List<RetailDrillDownReport>();
                ...
                searchRequest.GeneralUnitsName = _generalUnitsName;
                searchRequest.CentreName = _centreName;
                IBaseEntityCollectionResponse<RetailDrillDownReport> baseEntityCollectionResponse = _RetailDrillDownReportServiceAccess.GetMerchantiseBaseCategoryReportBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
        ...
        public List<RetailDrillDownReport> GetItemDescriptionList(string MarchandiseBaseCatgoryCode)
        {
            try
            {
                List<RetailDrillDownReport> listRetailDrillDownReport = new List<RetailDrillDownReport>();
                ...
                searchRequest.GeneralUnitsName = _generalUnitsName;
                searchRequest.CentreName = _centreName;
                IBaseEntityCollectionResponse<RetailDrillDownReport> baseEntityCollectionResponse = _RetailDrillDownReportServiceAccess.GetItemDescriptionReportBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
