    ...
    public class PurchaseOrderMasterAndDetailsController : BaseController
    {
        ...
        public FileStreamResult Download(PurchaseOrderMasterAndDetailsViewModel _model)
        {
            ...
            try
            {
                ...
                PurchasePDF = PurchasePDF + "<br><table border= '1' bgcolor='#fff;' color='black'><tr><th  bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Sr. No.</th><th  bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Item Name</th><th  bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Quantity</th><th  bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 0px;font-size:7pt'>Unit</th><th  bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Location</th>";
                if (_model.WithPORate == 1)
                {
                    PurchasePDF = PurchasePDF + "<th bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Tax</th><th bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Rate</th><th bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Amount</th><th bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Tax Amount</th><th bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Gross Amount</th>";
                }
                else
                {
                    PurchasePDF = PurchasePDF + "<th bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Rate</th><th bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 5px;font-size:7pt'>Amount</th>";
                }

                PurchasePDF = PurchasePDF + "<th  bgcolor='#D3D3D3' color='black' style='border: 1px solid black; border-collapse: collapse; text-align: center; padding: 0px;font-size:7pt'>Remark</th></tr>";
                ...
                DownloadPDF1(PurchasePDF, model.PurchaseOrderNumber, model.PurchaseOrderList[0].VendorNumber, model.PurchaseOrderList[0].IsDeleted, model.PurchaseOrderList[0].WaterMark);
        ...
        public void DownloadPDF1(string PurchasePDF, string PurchaseOrderNumber, int VendorNumber, bool IsDeleted,string WaterMark)
        {
            ...
            Response.BinaryWrite(GetPDF(PurchasePDF, IsDeleted, WaterMark));
            Response.End();
        }
        //Code For  Download PDF
        public byte[] GetPDF(string pHTML, bool IsDeleted,string WaterMark)
        {
            byte[] bPDF = null;
            ...
            BaseColor bc = new BaseColor(0, 0, 0, 15);
            iTextSharp.text.Font times = new iTextSharp.text.Font(bfTimes, 100.0F, iTextSharp.text.Font.ITALIC, bc);

            // Dim wfont = New Font(BaseFont.TIMES_ROMAN, 1.0F, BaseFont.COURIER, BaseColor.LIGHT_GRAY)
            ColumnText.ShowTextAligned(oPdfWriter.DirectContent, Element.ALIGN_CENTER, new Phrase(oPhrase, times), 350.0F, 350.0F, 55);
        ...
        public IEnumerable<PurchaseOrderMasterAndDetailsViewModel> GetPurchaseOrderMasterAndDetails(string PurchaseOrderType, string PurchaseOrderFromDate, string PurchaseOrderUptoDate, int AdminRoleID, out int TotalRecords)
        {
            PurchaseOrderMasterAndDetailsSearchRequest searchRequest = new PurchaseOrderMasterAndDetailsSearchRequest();
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            ...
            if (Enum.TryParse(_actionMode, out actionModeEnum))     // checks actionMode i.e. Insert or Update // 
            {
                if (actionModeEnum == ActionModeEnum.Insert)        // parameters for SelectAll procedures under Insert or Update mode condition
                {
                    ...
                    searchRequest.PurchaseOrderFromDate = Convert.ToString(PurchaseOrderFromDate);
                    searchRequest.PurchaseOrderUptoDate = Convert.ToString(PurchaseOrderUptoDate);
        ...
        // AjaxHandler Method
        #region ------------------AjaxHandler----------------------
        public ActionResult AjaxHandler(JQueryDataTableParamModel param, string PurchaseOrderFromDate, string PurchaseOrderUptoDate, string PurchaseOrderType, int AdminRoleID)
        {
            if (Session["UserType"] != null)
            {
                ...
                switch (Convert.ToInt32(sortColumnIndex))
                {
                    case 0:
                        ...
                        {
                            _searchBy = "A.PurchaseRequisitionNumber Like '%" + param.sSearch + "%' or A.PurchaseOrderNumber Like '%" + param.sSearch + "%' or  A.Vendor Like '%" + param.sSearch + "%'";      //this "if" block is added for search functionality
                ...
                {
                    filteredCountryMaster = GetPurchaseOrderMasterAndDetails(PurchaseOrderType, PurchaseOrderFromDate,PurchaseOrderUptoDate, AdminRoleID, out TotalRecords);
                }
                else
                {
                    filteredCountryMaster = new List<PurchaseOrderMasterAndDetailsViewModel>();
