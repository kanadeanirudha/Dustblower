    ...
    public class PurchaseGRNMasterController : BaseController
    {
        ...
        public FileStreamResult Downloads(int id)
        {
            ...
            try
            {
                ...
                DownloadPDF1(PurchasePDF, model.GRNNumber, model.PurchaseGRNMasterListFromPO[0].WaterMark);
        ...
        public void DownloadPDF1(string PurchasePDF, string GRNNumber,string WaterMark)
        {
            ...
            Response.BinaryWrite(GetPDF(PurchasePDF, WaterMark));
            Response.End();
        }
        //Code For  Download PDF
        public byte[] GetPDF(string pHTML,string WaterMark)
        {
            byte[] bPDF = null;
