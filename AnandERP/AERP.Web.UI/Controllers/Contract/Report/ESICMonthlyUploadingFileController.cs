...
namespace AERP.Web.UI.Controllers
{
    public class ESICMonthlyUploadingFileController : BaseController
    {
        ...
        public FileResult DownloadExcel(byte MonthName, string MonthYear,Int16 ESICZoneID,string CentreCode)
        {
            ...
            InsertExcelFile(filePath, MonthName, MonthYear, ESICZoneID, CentreCode);
        ...
        public void InsertExcelFile(string fileName, byte MonthName, string MonthYear,Int16 ESICZoneID,string CentreCode)
        {
            ...
            ESICMonthlyUploadingFileViewModel model = new ESICMonthlyUploadingFileViewModel();
            uint index = 3;
            model.ESICMonthlyUploadingFileList = GetESICMonthlyUploadingFileList(MonthName, MonthYear, ESICZoneID, CentreCode);
        ...
        public List<ESICMonthlyUploadingFile> GetESICMonthlyUploadingFileList(byte MonthName, string Monthyear,Int16 ESICZoneID,string CentreCode)
        {
            try
            {
                ...
                if (Monthyear != string.Empty)
                {
                    ...
                    searchRequest.ESICZoneID = ESICZoneID;
