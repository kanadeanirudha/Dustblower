    ...
    public class SaleContractMasterController : BaseController
    {
        ...
        public ActionResult SaleContractDetailsHome(string actionMode, string SaleContractMasterID, string ContractNumber)
        {
            try
            {
                ...
                _SaleContractMasterViewModel.SaleContractMasterDTO.ConnectionString = _connectionString;
                if (_SaleContractMasterViewModel.ID > 0)
                {
                    IBaseEntityResponse<SaleContractMaster> response = _SaleContractMasterBA.GetSaleContractApprovalStatus(_SaleContractMasterViewModel.SaleContractMasterDTO);
                    if (response != null && response.Entity != null)
                    {
                        _SaleContractMasterViewModel.SaleContractMasterDTO.ApprovalStatus = response.Entity.ApprovalStatus;
                    }
                }
                if (!string.IsNullOrEmpty(actionMode))
                {
        ...
        public ActionResult CreateGeneralContractDetails(string TaskCode, string SaleContractMasterID, string ContractNumber)
        {
        ...
        public ActionResult CreateGeneralModifyContract(string TaskCode, string SaleContractMasterID, string ContractNumber)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            model.TaskCode = TaskCode;
            model.ID = Convert.ToInt64(!string.IsNullOrEmpty(SaleContractMasterID) ? SaleContractMasterID : null);
        ...
        public ActionResult CreateGeneralExtendContract(string TaskCode, string SaleContractMasterID, string ContractNumber)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            model.TaskCode = TaskCode;
            model.ID = Convert.ToInt64(!string.IsNullOrEmpty(SaleContractMasterID) ? SaleContractMasterID : null);
        ...
        public ActionResult CreateGeneralShiftEmployee(string TaskCode, string SaleContractMasterID, string ContractNumber)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            model.TaskCode = TaskCode;
            model.ID = Convert.ToInt64(!string.IsNullOrEmpty(SaleContractMasterID) ? SaleContractMasterID : null);
        ...
        public ActionResult CreateGeneralRenewContract(string TaskCode, string SaleContractMasterID, string ContractNumber)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            model.TaskCode = TaskCode;
            model.ID = Convert.ToInt64(!string.IsNullOrEmpty(SaleContractMasterID) ? SaleContractMasterID : null);
        ...
        public ActionResult CreateGeneralCancelContract(string TaskCode, string SaleContractMasterID, string ContractNumber)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            model.TaskCode = TaskCode;
            model.ID = Convert.ToInt64(!string.IsNullOrEmpty(SaleContractMasterID) ? SaleContractMasterID : null);
        ...
        public ActionResult CreateGeneralUpdateAttendance(string TaskCode, string SaleContractMasterID, string ContractNumber)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            model.TaskCode = TaskCode;
            model.ID = Convert.ToInt64(!string.IsNullOrEmpty(SaleContractMasterID) ? SaleContractMasterID : null);
        ...
        [HttpGet]
        public ActionResult ManPowerItemListApproval(Int64 SaleContractMasterID)
        {
            SaleContractMasterViewModel SaleContractMasterViewModel = new SaleContractMasterViewModel();
            try
            {
                ...
                return PartialView("/Views/Contract/SaleContractMaster/ManPowerItemListApproval.cshtml", SaleContractMasterViewModel);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpGet]
        public ActionResult ContractMaterialListApproval(Int64 SaleContractMasterID)
        {
            SaleContractMasterViewModel SaleContractMasterViewModel = new SaleContractMasterViewModel();
            try
            {
                ...
                return PartialView("/Views/Contract/SaleContractMaster/ContractMaterialListApproval.cshtml", SaleContractMasterViewModel);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpGet]
        public ActionResult MachineMasterListApproval(Int64 SaleContractMasterID)
        {
            SaleContractMasterViewModel SaleContractMasterViewModel = new SaleContractMasterViewModel();
            try
            {
                ...
                return PartialView("/Views/Contract/SaleContractMaster/MachineMasterListApproval.cshtml", SaleContractMasterViewModel);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpGet]
        public ActionResult JobWorkItemListApproval(Int64 SaleContractMasterID)
        {
            SaleContractMasterViewModel SaleContractMasterViewModel = new SaleContractMasterViewModel();
            try
            {
                ...
                return PartialView("/Views/Contract/SaleContractMaster/JobWorkItemListApproval.cshtml", SaleContractMasterViewModel);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpGet]
        public ActionResult FixItemListApproval(Int64 SaleContractMasterID)
        {
            SaleContractMasterViewModel SaleContractMasterViewModel = new SaleContractMasterViewModel();
            try
            {
                ...
                return PartialView("/Views/Contract/SaleContractMaster/FixItemListApproval.cshtml", SaleContractMasterViewModel);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpGet]
        public ActionResult ServiceItemListApproval(Int64 SaleContractMasterID)
        {
            SaleContractMasterViewModel SaleContractMasterViewModel = new SaleContractMasterViewModel();
            try
            {
                ...
                return PartialView("/Views/Contract/SaleContractMaster/ServiceItemListApproval.cshtml", SaleContractMasterViewModel);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpGet]
        public ActionResult TermDetailsDataApproval(Int64 SaleContractMasterID, string TaskCode)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            try
            {
                ...
                return PartialView("/Views/Contract/SaleContractMaster/TermDetailsDataApproval.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpGet]
        public ActionResult SaleContractApproval(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            SaleContractMasterViewModel model = new SaleContractMasterViewModel();
            ...
            model.SaleContractMasterList = GetSaleContractRecord(PersonID, Convert.ToInt32(TNMID), model.GeneralTaskReportingDetailsID);
            model.ID = model.SaleContractMasterList[0].ID;
            model.ContractNumber = model.SaleContractMasterList[0].ContractNumber;
            ...
            return PartialView("/Views/Contract/SaleContractMaster/SaleContractApproval.cshtml", model);
        }

        [HttpPost]
        public ActionResult SaleContractApproval(SaleContractMasterViewModel model)
        {
            try
            {
                if (model != null && model.SaleContractMasterDTO != null)
                {
                    model.SaleContractMasterDTO.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);

                    model.SaleContractMasterDTO.PersonID = model.PersonID;
                    model.SaleContractMasterDTO.ID = model.ID;
                    model.SaleContractMasterDTO.IsLastRecord = Convert.ToBoolean(model.IsLastRecord);
                    model.SaleContractMasterDTO.TaskNotificationMasterID = model.TaskNotificationMasterID;
                    model.SaleContractMasterDTO.TaskNotificationDetailsID = model.TaskNotificationDetailsID;
                    model.SaleContractMasterDTO.GeneralTaskReportingDetailsID = model.GeneralTaskReportingDetailsID;
                    model.SaleContractMasterDTO.StageSequenceNumber = model.StageSequenceNumber;
                    model.SaleContractMasterDTO.ApprovedStatus = model.ApprovedStatus;
                    model.SaleContractMasterDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);

                    IBaseEntityResponse<SaleContractMaster> response = _SaleContractMasterBA.InsertSaleContractApproval(model.SaleContractMasterDTO);
                    model.SaleContractMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
                return Json(model.SaleContractMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        [NonAction]
        protected List<SaleContractMaster> GetSaleContractRecord(int personId, int taskNotificationMasterID, int GeneralTaskReportingDetailsID)
        {
            ...
            List<SaleContractMaster> listSaleContractDetails = new List<SaleContractMaster>();
            IBaseEntityCollectionResponse<SaleContractMaster> baseEntityCollectionResponse = _SaleContractMasterBA.GetSaleContractForApproval(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
                    listSaleContractDetails = baseEntityCollectionResponse.CollectionResponse.ToList();
                }
            }
            return listSaleContractDetails;
        }

        [HttpGet]
        public byte CheckSaleContractApprovalStatus(int SaleContractMasterID)
        {
            SaleContractMasterViewModel _SaleContractMasterViewModel = new SaleContractMasterViewModel();
            _SaleContractMasterViewModel.SaleContractMasterDTO.ConnectionString = _connectionString;
            _SaleContractMasterViewModel.ID = SaleContractMasterID;
            if (_SaleContractMasterViewModel.ID > 0)
            {
                IBaseEntityResponse<SaleContractMaster> response = _SaleContractMasterBA.GetSaleContractApprovalStatus(_SaleContractMasterViewModel.SaleContractMasterDTO);
                if (response != null && response.Entity != null)
            ...
            return _SaleContractMasterViewModel.SaleContractMasterDTO.ApprovalStatus;
        }
        #endregion
        ...
        [HttpPost]
        public JsonResult GetContractNumberSearchList(string term, string CentreCode)
        {
            SaleContractMasterSearchRequest searchRequest = new SaleContractMasterSearchRequest();
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            searchRequest.SearchWord = term;
        ...
        [HttpPost]
        public JsonResult GetContractNumberSearchListAll(string term)
        {
            SaleContractMasterSearchRequest searchRequest = new SaleContractMasterSearchRequest();
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            searchRequest.SearchWord = term;
            ...
            searchRequest.AdminRoleID = AdminRoleID;
            List<SaleContractMaster> listFeeSubType = new List<SaleContractMaster>();
            IBaseEntityCollectionResponse<SaleContractMaster> baseEntityCollectionResponse = _SaleContractMasterBA.GetContractNumberSearchListAll(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public ActionResult AjaxHandler(JQueryDataTableParamModel param)
        {
            ...
            var result = from c in records select new[] { Convert.ToString(c.ID), Convert.ToString(c.CustomerMasterName + (c.CustomerBranchMasterName != "" ? " (" + c.CustomerBranchMasterName + ")" : "")).Trim().Replace(",", "#"), Convert.ToString(c.ContractNumber), Convert.ToString(c.SaleContractType), Convert.ToString(c.Narration), Convert.ToString(c.ApprovalStatus) };
