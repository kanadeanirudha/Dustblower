...
namespace AERP.Web.UI.Controllers
{
    public class SaleContractAttendanceController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Convert.ToString(Session["UserType"]) == "A" || ((Convert.ToInt32(Session["HR Manager"]) > 0 || Convert.ToInt32(Session["HR Manager:Entity"]) > 0) && IsApplied == true))
            {
                ...
                foreach (var item in listAdminRoleApplicableDetails)
                {
                    ...
                    _SaleContractAttendanceViewModel.ListGetAdminRoleApplicableCentre.Add(a);
                }
        ...
        [HttpGet]
        public ActionResult ContractAttendanceApproval(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            SaleContractAttendanceViewModel model = new SaleContractAttendanceViewModel();
            ...
            model.SaleContractAttendanceList = GetContractAttendanceRecord(PersonID, Convert.ToInt32(TNMID), model.GeneralTaskReportingDetailsID);
            model.ID = model.SaleContractAttendanceList[0].ID;
            model.ContractNumber = model.SaleContractAttendanceList[0].ContractNumber;
            model.SaleContractBillingSpanName = model.SaleContractAttendanceList[0].SaleContractBillingSpanName;

            return PartialView("/Views/Contract/SaleContractAttendance/ContractAttendanceApproval.cshtml", model);
        }

        [HttpPost]
        public ActionResult ContractAttendanceApproval(SaleContractAttendanceViewModel model)
        {
            try
            {
                if (model != null && model.SaleContractAttendanceDTO != null)
                {
                    model.SaleContractAttendanceDTO.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);

                    model.SaleContractAttendanceDTO.PersonID = model.PersonID;
                    model.SaleContractAttendanceDTO.ID = model.ID;
                    model.SaleContractAttendanceDTO.IsLastRecord = Convert.ToBoolean(model.IsLastRecord);
                    model.SaleContractAttendanceDTO.TaskNotificationMasterID = model.TaskNotificationMasterID;
                    model.SaleContractAttendanceDTO.TaskNotificationDetailsID = model.TaskNotificationDetailsID;
                    model.SaleContractAttendanceDTO.GeneralTaskReportingDetailsID = model.GeneralTaskReportingDetailsID;
                    model.SaleContractAttendanceDTO.StageSequenceNumber = model.StageSequenceNumber;
                    model.SaleContractAttendanceDTO.ApprovedStatus = model.ApprovedStatus;
                    model.SaleContractAttendanceDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);

                    IBaseEntityResponse<SaleContractAttendance> response = _SaleContractAttendanceBA.InsertContractAttendanceApproval(model.SaleContractAttendanceDTO);
                    model.SaleContractAttendanceDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
                return Json(model.SaleContractAttendanceDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        [NonAction]
        protected List<SaleContractAttendance> GetContractAttendanceRecord(int personId, int taskNotificationMasterID, int GeneralTaskReportingDetailsID)
        {
            ...
            List<SaleContractAttendance> listSaleContractAttendanceDetails = new List<SaleContractAttendance>();
            IBaseEntityCollectionResponse<SaleContractAttendance> baseEntityCollectionResponse = _SaleContractAttendanceBA.GetContractAttendanceForApproval(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
                    listSaleContractAttendanceDetails = baseEntityCollectionResponse.CollectionResponse.ToList();
                }
            }
            return listSaleContractAttendanceDetails;
        }
