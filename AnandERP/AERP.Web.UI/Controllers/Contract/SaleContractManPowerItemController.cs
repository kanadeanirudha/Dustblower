...
namespace AERP.Web.UI.Controllers
{
    public class SaleContractManPowerItemController : BaseController
    {
        ...
        [HttpGet]
        public ActionResult ManPowerItemApproval(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            SaleContractManPowerItemViewModel model = new SaleContractManPowerItemViewModel();
            try
            {
                ...
                model.SaleContractManPowerItemList = GetManPowerItemRecord(PersonID, Convert.ToInt32(TNMID), model.GeneralTaskReportingDetailsID);
                model.ID = model.SaleContractManPowerItemList.Count > 0 ? model.SaleContractManPowerItemList[0].ID : 0;
                model.CustomerMasterName = model.SaleContractManPowerItemList.Count > 0 ? model.SaleContractManPowerItemList[0].CustomerMasterName : null;
                model.CustomerBranchMasterName = model.SaleContractManPowerItemList.Count > 0 ? model.SaleContractManPowerItemList[0].CustomerBranchMasterName : null;
                model.DesignationMasterName = model.SaleContractManPowerItemList.Count > 0 ? model.SaleContractManPowerItemList[0].DesignationMasterName : null;
                model.BasicSalayAmount = model.SaleContractManPowerItemList.Count > 0 ? model.SaleContractManPowerItemList[0].BasicSalayAmount : new decimal();
                model.FixedSalaryAmount = model.SaleContractManPowerItemList.Count > 0 ? model.SaleContractManPowerItemList[0].FixedSalaryAmount : new decimal();
                
                return PartialView("/Views/Contract/SaleContractManPowerItem/ManPowerItemApproval.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpPost]
        public ActionResult ManPowerItemApproval(SaleContractManPowerItemViewModel model)
        {
            try
            {
                if (model != null && model.SaleContractManPowerItemDTO != null)
                {
                    ...
                    model.SaleContractManPowerItemDTO.ConnectionString = _connectioString;
                    model.SaleContractManPowerItemDTO.PersonID = model.PersonID;
                    model.SaleContractManPowerItemDTO.ID = model.ID;
                    model.SaleContractManPowerItemDTO.IsLastRecord = Convert.ToBoolean(model.IsLastRecord);
                    model.SaleContractManPowerItemDTO.TaskNotificationMasterID = model.TaskNotificationMasterID;
                    model.SaleContractManPowerItemDTO.TaskNotificationDetailsID = model.TaskNotificationDetailsID;
                    model.SaleContractManPowerItemDTO.GeneralTaskReportingDetailsID = model.GeneralTaskReportingDetailsID;
                    model.SaleContractManPowerItemDTO.StageSequenceNumber = model.StageSequenceNumber;
                    model.SaleContractManPowerItemDTO.ApprovedStatus = model.ApprovedStatus;
                    model.SaleContractManPowerItemDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                    
                    IBaseEntityResponse<SaleContractManPowerItem> response = _SaleContractManPowerItemBA.InsertManPowerItemApproval(model.SaleContractManPowerItemDTO);
                    model.SaleContractManPowerItemDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
                return Json(model.SaleContractManPowerItemDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        [NonAction]
        protected List<SaleContractManPowerItem> GetManPowerItemRecord(int personId, int taskNotificationMasterID, int GeneralTaskReportingDetailsID)
        {
            ...
            List<SaleContractManPowerItem> listManPowerItemDetails = new List<SaleContractManPowerItem>();
            IBaseEntityCollectionResponse<SaleContractManPowerItem> baseEntityCollectionResponse = _SaleContractManPowerItemBA.GetManPowerItemForApproval(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
                    listManPowerItemDetails = baseEntityCollectionResponse.CollectionResponse.ToList();
                }
            }
            return listManPowerItemDetails;
        }
        #endregion
