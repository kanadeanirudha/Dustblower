...
namespace AERP.Web.UI.Controllers
{
    public class SaleContractSalaryTransactionController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Convert.ToString(Session["UserType"]) == "A" || (Convert.ToInt32(Session["Sales Manager"]) > 0 && IsApplied == true))
            {
                ...
                foreach (var item in listAdminRoleApplicableDetails)
                {
                    ...
                    _SaleContractSalaryTransactionViewModel.ListGetAdminRoleApplicableCentre.Add(a);
                }
        ...
        [HttpGet]
        public ActionResult GenerateBulkSalaryFS(string SaleContractMasterID, string SaleContractBillingSpanID)
        {
            SaleContractSalaryTransactionViewModel model = new SaleContractSalaryTransactionViewModel();
            ...
            return PartialView("/Views/Contract/SaleContractSalaryTransaction/GenerateBulkSalaryFS.cshtml", model);
        }
        ...
        [HttpGet]
        public ActionResult SalarySlipExcel(string SaleContractMasterID, string SaleContractBillingSpanID, string SaleContractEmployeeMasterID)
        {
            SaleContractSalaryTransactionViewModel model = new SaleContractSalaryTransactionViewModel();
            model.SaleContractSalaryTransactionDTO.SaleContractMasterID = Convert.ToInt64(SaleContractMasterID);
            model.SaleContractSalaryTransactionDTO.SaleContractBillingSpanID = Convert.ToInt64(SaleContractBillingSpanID);
            model.SaleContractSalaryTransactionDTO.SaleContractEmployeeMasterID = Convert.ToInt64(SaleContractEmployeeMasterID);

            model.SaleContractSalarySlipExcelList = GetSalaryTransactionForSalarySlipExcel(SaleContractMasterID, SaleContractBillingSpanID, SaleContractEmployeeMasterID);
        ...
        public ActionResult DownloadSalarySheet(SaleContractSalaryTransactionViewModel _model)
        {
            ...
            try
            {
                ...
                if (model.SaleContractSalaryTransactionList.Count > 0)
                {
                    ...
                    List<int> CheckedEmp = new List<int>();
                    ...
                    foreach (var item in model.SaleContractSalaryTransactionList)
                    {
                        if (Convert.ToInt32(SaleContractEmployeeMasterIDList[0]) == item.SaleContractEmployeeMasterID && Convert.ToInt32(SaleContractManPowerItemIDList[0]) == item.SaleContractManPowerItemID && item.IsAllowance == true && item.HeadType == "AddA" && item.ComplianceType == 1)
                        {
                            ...
                            {
                                if (Convert.ToInt32(SaleContractEmployeeMasterIDList[0]) == checkitem.SaleContractEmployeeMasterID && Convert.ToInt32(SaleContractManPowerItemIDList[0]) == checkitem.SaleContractManPowerItemID && checkitem.RuleType == "Deduction" && checkitem.ContributionType == 1 && checkitem.HeadType == "PF" && checkitem.ComplianceType == 1 && checkitem.CalculateOnString != "")
                                {
                    ...
                    foreach (var item in model.SaleContractSalaryTransactionList)
                    {
                        if (Convert.ToInt32(SaleContractEmployeeMasterIDList[0]) == item.SaleContractEmployeeMasterID && Convert.ToInt32(SaleContractManPowerItemIDList[0]) == item.SaleContractManPowerItemID && item.IsAllowance == true && item.HeadType != "DA" && item.HeadType != "RIA" && item.HeadType != "OT" && ((item.HeadType == "AddA" && item.ComplianceType == 1 && HeadAdditionalInTotal == false) || (item.HeadType != "AddA")))
                        {
                            ...
                            foreach (var checkitem in model.SaleContractSalaryTransactionList)
                            {
                                if (Convert.ToInt32(SaleContractEmployeeMasterIDList[0]) == checkitem.SaleContractEmployeeMasterID && Convert.ToInt32(SaleContractManPowerItemIDList[0]) == checkitem.SaleContractManPowerItemID && checkitem.RuleType == "Deduction" && checkitem.ContributionType == 1 && checkitem.HeadType == "ESIC" && checkitem.ComplianceType == 1 && checkitem.CalculateOnString != "")
                                {
                                    var CalculateOnValue = checkitem.CalculateOnString.Replace(", ", ",").Split(',');
                                    foreach (var CalOn in CalculateOnValue)
                                    {
                    ...
                    for (int manPowerID = 0, manPowerIDIndex = 1, manPowerListIndex = 0, j = 0; manPowerID < SaleContractManPowerItemIDList.Count(); manPowerID++, manPowerIDIndex++)
                    {
                        ...
                        {
                            if (model.SaleContractSalaryTransactionList[j].SaleContractManPowerItemID == Convert.ToInt32(SaleContractManPowerItemIDList[manPowerID]) && model.SaleContractSalaryTransactionList[j].SaleContractEmployeeMasterID == Convert.ToInt32(SaleContractEmployeeMasterIDList[i]) && !CheckedEmp.Contains(i))
                            {
                                CheckedEmp.Add(i);
            ...
            try
            {
                ...
                if (model.SaleContractSalaryTransactionList.Count > 0)
                {
                    ...
                    for (int manPowerID = 0, manPowerIDIndex = 1, manPowerListIndex = 0, j = 0; manPowerID < SaleContractManPowerItemIDList.Count(); manPowerID++, manPowerIDIndex++)
                    {
                        ...
                        for (int i = 0, k = 1; i < SaleContractEmployeeMasterIDList.Count(); i++)
                        {
                            if (model.SaleContractSalaryTransactionList[j].SaleContractManPowerItemID == Convert.ToInt32(SaleContractManPowerItemIDList[manPowerID]) && model.SaleContractSalaryTransactionList[j].SaleContractEmployeeMasterID == Convert.ToInt32(SaleContractEmployeeMasterIDList[i]) && model.SaleContractSalaryTransactionList[i].SaleContractManPowerItemID == Convert.ToInt32(SaleContractManPowerItemIDList[manPowerID]))
                            {
                        ...
                        for (int bhu = 0; bhu < SaleContractEmployeeMasterIDList.Count(); bhu++)
                        {
                            ...
                            foreach (var item in model.SaleContractSalaryTransactionList)
                            {
                                if (item.SaleContractManPowerItemID == Convert.ToInt32(SaleContractManPowerItemIDList[manPowerID]) && item.SaleContractEmployeeMasterID == Convert.ToInt32(SaleContractEmployeeMasterIDList[bhu]) && model.SaleContractSalaryTransactionList[bhu].SaleContractManPowerItemID == Convert.ToInt32(SaleContractManPowerItemIDList[manPowerID]) && DataAdded1 == false)
                                {
        ...
        protected List<SaleContractSalaryTransaction> GetSalaryTransactionForSalarySlipExcel(string SaleContractMasterID, string SaleContractBillingSpanID,string SaleContractEmployeeMasterID)
        {
