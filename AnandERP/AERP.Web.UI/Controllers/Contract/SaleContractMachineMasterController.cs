        ...
        public ActionResult AjaxHandler(JQueryDataTableParamModel param, string CentreCode)
        {
            ...
            switch (Convert.ToInt32(sortColumnIndex))
            {
                case 0:
                    ...
                    {
                        _searchBy = "B.ItemDescription Like '%" + param.sSearch + "%' or A.Name Like '%" + param.sSearch + "%' or A.SerialNumber Like '%" + param.sSearch + "%' or CompanyName Like '%" + param.sSearch + "%' or BranchName Like '%" + param.sSearch + "%'";        //this "if" block is added for search functionality
                    }
                    break;
                case 1:
                    _sortBy = "A.Name";
