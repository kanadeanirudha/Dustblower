...
namespace AERP.Web.UI.Controllers
{
    public class SaleContractBillingTransactionController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult SaveInvoice(SaleContractBillingTransactionViewModel model)
        {
            try
            {
                if (model != null && model.SaleContractBillingTransactionDTO != null)
                {
                    ...
                    model.SaleContractBillingTransactionDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<SaleContractBillingTransaction> response = _SaleContractBillingTransactionBA.SaveSaleContractInvoiceTransaction(model.SaleContractBillingTransactionDTO);
        ...
        [HttpGet]
        public FileStreamResult Download(string SaleContractMasterID, string SaleContractBillingSpanID, string ActionType)
        {
            return DownloadPDF(SaleContractMasterID, SaleContractBillingSpanID, ActionType, false);
        }

        [HttpGet]
        public FileStreamResult DownloadEInvoice(string SaleContractMasterID, string SaleContractBillingSpanID, string ActionType)
        {
            return DownloadPDF(SaleContractMasterID, SaleContractBillingSpanID, ActionType, true);
        }

        private FileStreamResult DownloadPDF(string SaleContractMasterID, string SaleContractBillingSpanID, string ActionType, bool isEInvoice)
        {
            SaleContractBillingTransactionViewModel model = new SaleContractBillingTransactionViewModel();
            try
            {
                ...
                model.SaleContractBillingTransactionList = GetBillingTransactionDetailsByIDForInvoicePDF(SaleContractMasterID, SaleContractBillingSpanID, ActionType);
                ...
                string FromDetailTable = string.Empty;
                if (ActionType == "Save")
                {
                    FromDetailTable = "TempSaleContractInvoiceDetails";
                }
                else
                {
                ...
                if (!string.IsNullOrEmpty(qrImage) && isEInvoice)
                {
                ...
                //SaleContractInvoicePDF = SaleContractInvoicePDF + "</table>";
                DownloadPDF1(SaleContractInvoicePDF, model.CustomerInvoiceNumber, Convert.ToInt32(model.SaleContractBillingTransactionList[0].SaleContractMasterID), model.SaleContractBillingTransactionList[0].IsCanceled, model.SaleContractBillingTransactionList[0].WaterMark);
                MemoryStream workStream = new MemoryStream();
        ...
        public void DownloadPDF1(string SaleContractInvoicePDF, string CustomerInvoiceNumber, int SaleContractMasterID, bool IsCanceled, string WaterMark)
        {
            ...
            Response.Cache.SetCacheability(HttpCacheability.NoCache);
            Response.BinaryWrite(GetPDF(SaleContractInvoicePDF, IsCanceled, WaterMark));
            Response.End();
        }
        ...
        public byte[] GetPDF(string pHTML, bool IsCanceled, string WaterMark)
        {
            ...
            if (IsCanceled == true)
            {
                //    PdfLayer layer = new PdfLayer("WatermarkLayer", oPdfWriter.Writer);
            ...
            ColumnText.ShowTextAligned(oPdfWriter.DirectContent, Element.ALIGN_CENTER, new Phrase(WaterMark, times), 350.0F, 350.0F, 55);
        ...
        protected List<SaleContractBillingTransaction> GetBillingTransactionDetailsByIDForInvoicePDF(string SaleContractMasterID, string SaleContractBillingSpanID, string ActionType)
        {
        ...
        [NonAction]
        public IEnumerable<SaleContractBillingTransactionViewModel> GetSaleContractBillingTransaction(out int TotalRecords, string CustomerMasterID, string CustomerBranchMasterID)
        {
            try
            {
                SaleContractBillingTransactionSearchRequest searchRequest = new SaleContractBillingTransactionSearchRequest();
