...
namespace AERP.Web.UI.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult GetNotificationCount()
        {
            ...
            ITaskNotificationBA _TaskNotificationBA = new TaskNotificationBA();

            TaskNotificationViewModel _TaskNotificationViewModel = new TaskNotificationViewModel();
            _TaskNotificationViewModel.EmployeeID = Convert.ToInt32(Session["PersonID"]);
            _TaskNotificationViewModel.TaskNotificationDTO.ConnectionString = _connectioString;
            IBaseEntityResponse<TaskNotification> response = _TaskNotificationBA.GetNotificationCountEmployeewise(_TaskNotificationViewModel.TaskNotificationDTO);
            int result = 0;
            if (response != null && response.Entity != null)
            {
                result = Convert.ToInt32(response.Entity.NotificationCount);
            }
