...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IEmployeeDocumentRequiredServiceAccess _EmployeeDocumentRequiredServiceAccess = null;
        ...
        {
            _EmployeeDocumentRequiredServiceAccess = new EmployeeDocumentRequiredServiceAccess();
        }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeDocumentRequiredDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeDocumentRequired> response = _EmployeeDocumentRequiredServiceAccess.InsertEmployeeDocumentRequired(model.EmployeeDocumentRequiredDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeDocumentRequiredDTO != null)
                    {
                        if (model != null && model.EmployeeDocumentRequiredDTO != null)
                        {
                            ...
                            IBaseEntityResponse<EmployeeDocumentRequired> response = _EmployeeDocumentRequiredServiceAccess.UpdateEmployeeDocumentRequired(model.EmployeeDocumentRequiredDTO);
        ...
        public IEnumerable<EmployeeDocumentRequiredViewModel> GetEmployeeDocumentRequiredDetails(out int TotalRecords, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeDocumentRequired> baseEntityCollectionResponse = _EmployeeDocumentRequiredServiceAccess.GetBySearch(searchRequest);
        ...
        protected List<EmployeeDocumentRequired> GetEmployeeDocumentRequiredByLeaveRuleMasterID(int LeaveRuleMasterID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeDocumentRequired> baseEntityCollectionResponse = _EmployeeDocumentRequiredServiceAccess.SelectByLeaveRuleMasterID(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
