...
namespace AERP.Web.UI.Controllers
{
    public class EmployeeShiftMasterController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeShiftMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeShiftMaster> response = _EmployeeShiftMasterBA.InsertEmployeeShiftMaster(model.EmployeeShiftMasterDTO);
        ...
        public ActionResult EditShift(int EmployeeShiftMasterID)
        {
            ...
            IBaseEntityResponse<EmployeeShiftMaster> response = _EmployeeShiftMasterBA.SelectByEmployeeShiftMasterID(_employeeShiftMasterViewModel.EmployeeShiftMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeShiftMasterDTO != null)
                    {
                        if (model != null && model.EmployeeShiftMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<EmployeeShiftMaster> response = _EmployeeShiftMasterBA.UpdateEmployeeShiftMaster(model.EmployeeShiftMasterDTO);
            ...
            try
            {
                if (model.EmployeeShiftMasterID > 0)
                {
                    if (model != null && model.EmployeeShiftMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeShiftMaster> response = _EmployeeShiftMasterBA.InsertEmployeeShiftMasterDetails(EmployeeShiftMasterDTO);
                        model.EmployeeShiftMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    return Json(model.EmployeeShiftMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        public ActionResult EditEmployeeShiftMasterDetails(string EmployeeShiftMasterDetailsID, string EmployeeShiftDescription)
        {
            ...
            IBaseEntityResponse<EmployeeShiftMaster> response = _EmployeeShiftMasterBA.SelectByEmployeeShiftMasterDetailsID(_employeeShiftMasterViewModel.EmployeeShiftMasterDTO);
            ...
            try
            {
                if (model.EmployeeShiftMasterID > 0)
                {
                    if (model != null && model.EmployeeShiftMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeShiftMaster> response = _EmployeeShiftMasterBA.UpdateEmployeeShiftMasterDetails(EmployeeShiftMasterDTO);
                        model.EmployeeShiftMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                    return Json(model.EmployeeShiftMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        public IEnumerable<EmployeeShiftMasterViewModel> GetEmployeeShiftMasterRecords(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeShiftMaster> baseEntityCollectionResponse = _EmployeeShiftMasterBA.GetBySearch(searchRequest);
