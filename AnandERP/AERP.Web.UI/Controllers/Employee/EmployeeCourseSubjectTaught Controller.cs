...
namespace AMS.Web.UI.Controllers
{
    public class EmployeeCourseSubjectTaughtController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeCourseSubjectTaughtDTO != null)
                    {
                        ...
                        model.EmployeeCourseSubjectTaughtDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeCourseSubjectTaughtDTO != null)
                    {
                        if (model != null && model.EmployeeCourseSubjectTaughtDTO != null)
                        {
                            ...
                            model.EmployeeCourseSubjectTaughtDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                        }
                    }
                    return Json(model.EmployeeCourseSubjectTaughtDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        [HttpPost]
        public ActionResult Delete(EmployeeCourseSubjectTaughtViewModel model)
        {
            try
            {
                ...
                if (model.ID > 0)
                {
                    if (model != null && model.EmployeeCourseSubjectTaughtDTO != null)
                    {
                        ...
                        model.EmployeeCourseSubjectTaughtDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    return Json(model.EmployeeCourseSubjectTaughtDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
