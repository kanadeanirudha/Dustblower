    ...
    public class EmployeeShiftApplicableMasterController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeShiftApplicableMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeShiftApplicableMaster> response = _employeeShiftApplicableMasterBA.InsertEmployeeShiftApplicableMaster(model.EmployeeShiftApplicableMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            try
            {
                ...
                IBaseEntityResponse<EmployeeShiftApplicableMaster> response = _employeeShiftApplicableMasterBA.SelectByID(_employeeShiftApplicableMasterViewModel.EmployeeShiftApplicableMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeShiftApplicableMasterDTO != null)
                    {
                        if (model != null && model.EmployeeShiftApplicableMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<EmployeeShiftApplicableMaster> response = _employeeShiftApplicableMasterBA.UpdateEmployeeShiftApplicableMaster(model.EmployeeShiftApplicableMasterDTO);
            ...
            try
            {
                if (model.ID > 0)
                {
                    if (model != null && model.EmployeeShiftApplicableMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeShiftApplicableMaster> response = _employeeShiftApplicableMasterBA.InsertEmployeeShiftApplicableMaster(EmployeeShiftApplicableMasterDTO);
                        model.EmployeeShiftApplicableMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    return Json(model.EmployeeShiftApplicableMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
            ...
            try
            {
                if (model.ID > 0)
                {
                    if (model != null && model.EmployeeShiftApplicableMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeShiftApplicableMaster> response = _employeeShiftApplicableMasterBA.UpdateEmployeeShiftApplicableMaster(EmployeeShiftApplicableMasterDTO);
                        model.EmployeeShiftApplicableMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                    return Json(model.EmployeeShiftApplicableMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        public IEnumerable<EmployeeShiftApplicableMasterViewModel> GetEmployeeShiftApplicableMasterRecords(out int TotalRecords, string CentreCode, string DepartmentID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeShiftApplicableMaster> baseEntityCollectionResponse = _employeeShiftApplicableMasterBA.GetBySearch(searchRequest);
        ...
        public List<EmployeeShiftMaster> GetEmployeeShiftMasterDetails(int EmployeeShiftMasterID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeShiftMaster> baseEntityCollectionResponse = _employeeShiftMasterBA.GetEmployeeShiftMasterDetailsBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<GeneralWeekDays> GetGeneralWeekDaysList(int LeaveEmployeeShiftTransactionID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralWeekDays> baseEntityCollectionResponse = _generalWeekDaysBA.GetGeneralWeekDayList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
