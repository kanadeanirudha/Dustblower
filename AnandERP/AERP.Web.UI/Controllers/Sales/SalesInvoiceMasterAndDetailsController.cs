...
namespace AERP.Web.UI.Controllers
{
    public class SalesInvoiceMasterAndDetailsController : BaseController
    {
        ...
        public void DownloadPDF1(string SalesInvoicePDF, string CustomerInvoiceNumber, int CustomerMasterID, bool IsCanceled,string WaterMark)
        {
            ...
            Response.BinaryWrite(GetPDF(SalesInvoicePDF, IsCanceled, WaterMark));
            Response.End();
        }
        ...
        [HttpGet]
        public ActionResult SalesInvoiceApproval(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            SalesInvoiceMasterAndDetailsViewModel model = new SalesInvoiceMasterAndDetailsViewModel();
            try
            {
                ...
                model.SalesinvoiceList = GetSalesInvoiceRecord(PersonID, Convert.ToInt32(TNMID), model.GeneralTaskReportingDetailsID);
                model.ID = model.SalesinvoiceList.Count > 0 ? model.SalesinvoiceList[0].ID : 0;
                model.CustomerInvoiceNumber = model.SalesinvoiceList.Count > 0 ? model.SalesinvoiceList[0].CustomerInvoiceNumber : null;
                model.CustomerName = model.SalesinvoiceList.Count > 0 ? model.SalesinvoiceList[0].CustomerName : null;
                model.Amount = model.SalesinvoiceList.Count > 0 ? model.SalesinvoiceList[0].Amount : new decimal();
                model.InvoiceType = model.SalesinvoiceList.Count > 0 ? model.SalesinvoiceList[0].InvoiceType : new byte();
                model.IsOtherState = model.SalesinvoiceList.Count > 0 ? model.SalesinvoiceList[0].IsOtherState : new bool();
                model.SalesOrderMasterID = model.SalesinvoiceList.Count > 0 ? model.SalesinvoiceList[0].SalesOrderMasterID : new int();

                return PartialView("/Views/Sales/SalesInvoiceMasterAndDetails/SalesInvoiceApproval.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpPost]
        public ActionResult SalesInvoiceApproval(SalesInvoiceMasterAndDetailsViewModel model)
        {
            try
            {
                if (model != null && model.SalesInvoiceMasterAndDetailsDTO != null)
                {
                    model.SalesInvoiceMasterAndDetailsDTO.ConnectionString = _connectioString;

                    model.SalesInvoiceMasterAndDetailsDTO.ConnectionString = _connectioString;
                    model.SalesInvoiceMasterAndDetailsDTO.PersonID = model.PersonID;
                    model.SalesInvoiceMasterAndDetailsDTO.ID = model.ID;
                    model.SalesInvoiceMasterAndDetailsDTO.IsLastRecord = Convert.ToBoolean(model.IsLastRecord);
                    model.SalesInvoiceMasterAndDetailsDTO.TaskNotificationMasterID = model.TaskNotificationMasterID;
                    model.SalesInvoiceMasterAndDetailsDTO.TaskNotificationDetailsID = model.TaskNotificationDetailsID;
                    model.SalesInvoiceMasterAndDetailsDTO.GeneralTaskReportingDetailsID = model.GeneralTaskReportingDetailsID;
                    model.SalesInvoiceMasterAndDetailsDTO.StageSequenceNumber = model.StageSequenceNumber;
                    model.SalesInvoiceMasterAndDetailsDTO.ApprovedStatus = model.ApprovedStatus;
                    model.SalesInvoiceMasterAndDetailsDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);

                    IBaseEntityResponse<SalesInvoiceMasterAndDetails> response = _SalesInvoiceMasterAndDetailsBA.InsertSalesInvoiceApproval(model.SalesInvoiceMasterAndDetailsDTO);
                    model.SalesInvoiceMasterAndDetailsDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
                return Json(model.SalesInvoiceMasterAndDetailsDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        public ActionResult CancelSalesInvoiceApproval(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            SalesInvoiceMasterAndDetailsViewModel model = new SalesInvoiceMasterAndDetailsViewModel();
            try
            {
                ...
                return PartialView("/Views/Sales/SalesInvoiceMasterAndDetails/CancelSalesInvoiceApproval.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        [HttpPost]
        public ActionResult CancelSalesInvoiceApproval(SalesInvoiceMasterAndDetailsViewModel model)
        {
            try
            {
                if (model != null && model.SalesInvoiceMasterAndDetailsDTO != null)
                {
                    ...
                    IBaseEntityResponse<SalesInvoiceMasterAndDetails> response = _SalesInvoiceMasterAndDetailsBA.InsertCancelSalesInvoiceApproval(model.SalesInvoiceMasterAndDetailsDTO);
                    model.SalesInvoiceMasterAndDetailsDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
                return Json(model.SalesInvoiceMasterAndDetailsDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        [NonAction]
        protected List<SalesInvoiceMasterAndDetails> GetSalesInvoiceRecord(int personId, int taskNotificationMasterID, int GeneralTaskReportingDetailsID)
        {
            SalesInvoiceMasterAndDetailsSearchRequest searchRequest = new SalesInvoiceMasterAndDetailsSearchRequest();
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            ...
            List<SalesInvoiceMasterAndDetails> listSalesInvoiceDetails = new List<SalesInvoiceMasterAndDetails>();
            IBaseEntityCollectionResponse<SalesInvoiceMasterAndDetails> baseEntityCollectionResponse = _SalesInvoiceMasterAndDetailsBA.GetSalesInvoiceForApproval(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
                    listSalesInvoiceDetails = baseEntityCollectionResponse.CollectionResponse.ToList();
                }
            }
        ...
        public IEnumerable<SalesInvoiceMasterAndDetailsViewModel> GetSalesInvoiceMasterAndDetails(out int TotalRecords, int AdminRoleID, string MonthName, string MonthYear)
        {
            SalesInvoiceMasterAndDetailsSearchRequest searchRequest = new SalesInvoiceMasterAndDetailsSearchRequest();
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
        ...
        public IEnumerable<SalesInvoiceMasterAndDetailsViewModel> GetServiceInvoiceMasterAndDetails(out int TotalRecords, int AdminRoleID, string MonthName, string MonthYear)
        {
            SalesInvoiceMasterAndDetailsSearchRequest searchRequest = new SalesInvoiceMasterAndDetailsSearchRequest();
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            //searchRequest.PurchaseOrderType = Convert.ToInt16(PurchaseOrderType);
        ...
        // AjaxHandler Method
        #region ------------------AjaxHandler----------------------
        public ActionResult AjaxHandler(JQueryDataTableParamModel param, int AdminRoleID, string MonthName, string MonthYear)
        {
        ...
        public ActionResult ServiceInvoiceAjaxHandler(JQueryDataTableParamModel param, int AdminRoleID, string MonthName, string MonthYear)
        {
            if (Session["UserType"] != null)
            {
                int TotalRecords;
