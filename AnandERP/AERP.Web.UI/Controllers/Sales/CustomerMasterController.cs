...
namespace AERP.Web.UI.Controllers
{
    public class CustomerMasterController : BaseController
    {
        ...
        [HttpPost]
        public JsonResult GetCustomerBranch(string term)
        {
            ...
            List<CustomerMaster> listFeeSubType = new List<CustomerMaster>();
            IBaseEntityCollectionResponse<CustomerMaster> baseEntityCollectionResponse = _CustomerMasterBA.GetCustomerBranchSearchListAll(searchRequest);
