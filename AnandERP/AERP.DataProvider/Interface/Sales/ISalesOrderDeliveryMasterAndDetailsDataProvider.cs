...
namespace AERP.DataProvider
{
    public interface ISalesOrderDeliveryMasterAndDetailsDataProvider
    {
        ...
        IBaseEntityCollectionResponse<SalesOrderDeliveryMasterAndDetails> GetDeliveryMemoSaleOrderDetailsByID(SalesOrderDeliveryMasterAndDetailsSearchRequest searchRequest);
