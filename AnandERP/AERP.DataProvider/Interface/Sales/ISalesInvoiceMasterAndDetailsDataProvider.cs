...
namespace AERP.DataProvider
{
    public interface ISalesInvoiceMasterAndDetailsDataProvider
    {
        ...
        IBaseEntityResponse<SalesInvoiceMasterAndDetails> SaveDirectSalesInvoiceMasterAndDetails(SalesInvoiceMasterAndDetails item);
        ...
        IBaseEntityResponse<GSTInvoiceResponseModel> InsertUpdateSalesEInvoiceResponse(GSTInvoiceResponseModel item);
    }
}
