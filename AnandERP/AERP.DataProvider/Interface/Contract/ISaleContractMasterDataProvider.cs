...
{
    public interface ISaleContractMasterDataProvider
    {
        ...
        IBaseEntityCollectionResponse<SaleContractMaster> GetContractNumberSearchListAll(SaleContractMasterSearchRequest searchRequest);
        ...
        IBaseEntityCollectionResponse<SaleContractMaster> GetSaleContractForApproval(SaleContractMasterSearchRequest searchRequest);
        IBaseEntityResponse<SaleContractMaster> InsertSaleContractApproval(SaleContractMaster item);
        IBaseEntityResponse<SaleContractMaster> GetSaleContractApprovalStatus(SaleContractMaster item);
    }
}
