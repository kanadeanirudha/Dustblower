...
namespace AERP.DataProvider
{
    public interface ISaleContractManPowerItemDataProvider
    {
        ...
        IBaseEntityResponse<SaleContractManPowerItem> InsertManPowerItemApproval(SaleContractManPowerItem item);
        IBaseEntityCollectionResponse<SaleContractManPowerItem> GetManPowerItemForApproval(SaleContractManPowerItemSearchRequest searchRequest);
    }
}
