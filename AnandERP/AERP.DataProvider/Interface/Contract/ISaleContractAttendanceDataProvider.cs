...
{
    public interface ISaleContractAttendanceDataProvider
    {
        ...
        IBaseEntityResponse<SaleContractAttendance> InsertContractAttendanceApproval(SaleContractAttendance item);
        IBaseEntityCollectionResponse<SaleContractAttendance> GetContractAttendanceForApproval(SaleContractAttendanceSearchRequest searchRequest);
    }
}
