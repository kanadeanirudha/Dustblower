...
{
    public class GeneralRequestMasterDataProvider : DBInteractionBase, IGeneralRequestMasterDataProvider
    {
        ...
        /// </summary>
        public GeneralRequestMasterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public GeneralRequestMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralRequestMaster> GetGeneralRequestMasterBySearch(GeneralRequestMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<GeneralRequestMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<GeneralRequestMaster>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestMaster_SelectAll";
                 ...
                 //   cmdToExecute.Parameters.Add(new SqlParameter("@iDepartmentID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.DepartmentID));
                    ...
                    baseEntityCollection.CollectionResponse = new List<GeneralRequestMaster>();
                    while (sqlDataReader.Read())
                    {
                        GeneralRequestMaster item = new GeneralRequestMaster();

                        item.ID = sqlDataReader["ID"] is DBNull ? new short() : Convert.ToInt32(sqlDataReader["ID"]);
                        item.RequestCode = sqlDataReader["RequestCode"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["RequestCode"]);
                        item.RequestDescription = sqlDataReader["RequestDescription"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["RequestDescription"]);
                        item.MenuCode = sqlDataReader["MenuCode"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["MenuCode"]);
                        item.RequestApprovalBasedTable = sqlDataReader["RequestApprovalBasedTable"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["RequestApprovalBasedTable"]);
                        item.RequestApprovalParamPrimaryKey = sqlDataReader["RequestApprovalParamPrimaryKey"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["RequestApprovalParamPrimaryKey"]);
                        //item.LinkMenuCode = sqlDataReader["LinkMenuCode"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["LinkMenuCode"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralRequestMaster_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<GeneralRequestMaster> GetGeneralRequestMasterSearchList(GeneralRequestMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestMaster_GetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.RequestCode = sqlDataReader["RequestCode"].ToString();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralRequestMaster_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<GeneralRequestMaster> GetRequestCode(GeneralRequestMasterSearchRequest searchRequest)
        {
            ...
            IBaseEntityCollectionResponse<GeneralRequestMaster> baseEntityCollection = new BaseEntityCollectionResponse<GeneralRequestMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestMaster_SearchListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    //-----------------------------------------------------Output Parameters ------------------------------------------------------------------
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    //-----------------------------------------------------Input Parameters ------------------------------------------------------------------
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralRequestMaster> GetGeneralRequestMasterByID(GeneralRequestMaster item)
        {
            IBaseEntityResponse<GeneralRequestMaster> response = new BaseEntityResponse<GeneralRequestMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        GeneralRequestMaster _item = new GeneralRequestMaster();
        ...
        public IBaseEntityResponse<GeneralRequestMaster> InsertGeneralRequestMaster(GeneralRequestMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Input, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsRequestCode", SqlDbType.NVarChar, 10,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.RequestCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsRequestDescription", SqlDbType.NVarChar, 200,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.RequestDescription));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsMenuCode", SqlDbType.NVarChar, 50,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.MenuCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsRequestApprovalBasedTable", SqlDbType.NVarChar, 50,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.RequestApprovalBasedTable));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsRequestApprovalParamPrimaryKey", SqlDbType.NVarChar, 20,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.RequestApprovalParamPrimaryKey));
                    //cmdToExecute.Parameters.Add(new SqlParameter("@nsLinkMenuCode", SqlDbType.NVarChar, 20,
                    //                        ParameterDirection.Input, false, 10, 0, "",
                    //                        DataRowVersion.Proposed, item.LinkMenuCode));
                    ...
                    //if (_rowsAffected > 0)
                    //{
                    //    item.ID = (Int16)cmdToExecute.Parameters["@iGeneralRequestMasterID"].Value;
                    //}
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_GeneralRequestMaster_Insert' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralRequestMaster_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<GeneralRequestMaster> UpdateGeneralRequestMaster(GeneralRequestMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_GeneralRequestMaster_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of GeneralRequestMaster
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<GeneralRequestMaster> DeleteGeneralRequestMaster(GeneralRequestMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Input, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralRequestMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
