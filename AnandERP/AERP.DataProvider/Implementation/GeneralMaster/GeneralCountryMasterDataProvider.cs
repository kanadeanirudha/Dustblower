...
{
    public class GeneralCountryMasterDataProvider : DBInteractionBase, IGeneralCountryMasterDataProvider
    {
        ...
        /// </summary>
        public GeneralCountryMasterDataProvider()
        {
        }
        ...
        public GeneralCountryMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralCountryMaster> GetGeneralCountryMasterBySearch(GeneralCountryMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_GeneralCountryMaster_SelectAll";
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralCountryMaster_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralCountryMaster> GetGeneralCountryMasterByID(GeneralCountryMaster item)
        {
            IBaseEntityResponse<GeneralCountryMaster> response = new BaseEntityResponse<GeneralCountryMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCountryMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        GeneralCountryMaster _item = new GeneralCountryMaster();
        ...
        public IBaseEntityResponse<GeneralCountryMaster> InsertGeneralCountryMaster(GeneralCountryMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCountryMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                         //Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralCountryMaster_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
        ...
        public IBaseEntityResponse<GeneralCountryMaster> UpdateGeneralCountryMaster(GeneralCountryMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCountryMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        public IBaseEntityResponse<GeneralCountryMaster> DeleteGeneralCountryMaster(GeneralCountryMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCountryMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralCountryMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (SqlException ex)
