...
{
    public class AccountNarrationMasterDataProvider: DBInteractionBase,IAccountNarrationMasterDataProvider
    {
        ...
        #region Constructor
        public AccountNarrationMasterDataProvider(){}
        public AccountNarrationMasterDataProvider(ILogger logException) 
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<AccountNarrationMaster> GetAccountNarrationMasterBySearch(AccountNarrationMasterSearchRequest searchRequest)
        {
            //throw new NotImplementedException();
            IBaseEntityCollectionResponse<AccountNarrationMaster> baseEntityCollection = new BaseEntityCollectionResponse<AccountNarrationMaster>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_AccountNarrationMaster_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<AccountNarrationMaster>();
                    while (sqlDataReader.Read())
                    {
                        AccountNarrationMaster item = new AccountNarrationMaster();
                        item.ID = Convert.ToInt32(sqlDataReader["ID"]);
                        item.NarrationDescription = Convert.ToString(sqlDataReader["NarrationDescription"]);
                        item.NarrationType = Convert.ToString(sqlDataReader["NarrationType"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountNarrationMaster_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <summary>
        /// Select a record from Account narration master by ID
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<AccountNarrationMaster> GetAccountNarrationMasterByID(AccountNarrationMaster item)
        {
            //throw new NotImplementedException();
            IBaseEntityResponse<AccountNarrationMaster> response = new BaseEntityResponse<AccountNarrationMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountNarrationMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        AccountNarrationMaster _item = new AccountNarrationMaster();
                        _item.ID = Convert.ToInt32(sqlDataReader["ID"]);
                        _item.NarrationDescription = Convert.ToString(sqlDataReader["NarrationDescription"]);
                        _item.NarrationType = Convert.ToString(sqlDataReader["NarrationType"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountNarrationMaster_SelectOne' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<AccountNarrationMaster> InsertAccountNarrationMaster(AccountNarrationMaster item)
        {
            //throw new NotImplementedException();
            IBaseEntityResponse<AccountNarrationMaster> response = new BaseEntityResponse<AccountNarrationMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountNarrationMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@cNarrationType", SqlDbType.Char, 1, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, item.NarrationType));
                    cmdToExecute.Parameters.Add(new SqlParameter("@bIsActive", SqlDbType.Bit, 1, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, item.IsActive));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountNarrationMaster_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<AccountNarrationMaster> UpdateAccountNarrationMaster(AccountNarrationMaster item)
        {
            //throw new NotImplementedException();
            IBaseEntityResponse<AccountNarrationMaster> response = new BaseEntityResponse<AccountNarrationMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountNarrationMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountNarrationMaster_Update' reported the ErrorCode: " + _errorCode);
                    }
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<AccountNarrationMaster> DeleteAccountNarrationMaster(AccountNarrationMaster item)
        {
            //throw new NotImplementedException();
            IBaseEntityResponse<AccountNarrationMaster> response = new BaseEntityResponse<AccountNarrationMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountNarrationMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountNarrationMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
