...
{
    public class AccountHeadMasterReportDataProvider: DBInteractionBase, IAccountHeadMasterReportDataProvider
    {
        ...
        /// </summary>
        public AccountHeadMasterReportDataProvider()
        {
        }
        ...
        public AccountHeadMasterReportDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<AccountHeadMasterReport> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<AccountHeadMasterReport>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_AccountHeadMaster_Report";
                    ...
                    baseEntityCollection.CollectionResponse = new List<AccountHeadMasterReport>();
                    while (sqlDataReader.Read())
                    {
                        AccountHeadMasterReport item = new AccountHeadMasterReport();
                        ...
                        item.PrintingSequence = Convert.ToInt32(sqlDataReader["PrintingSequence"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountHeadMasterReport_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<AccountHeadMasterReport> GetAccountHeadNameList(AccountHeadMasterReportSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountHeadMasterReport_SearchList";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountHeadMasterReport_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        {
            IBaseEntityResponse<AccountHeadMasterReport> response = new BaseEntityResponse<AccountHeadMasterReport>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountHeadMasterReport_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        AccountHeadMasterReport _item = new AccountHeadMasterReport();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountHeadMasterReport_SelectOne' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityResponse<AccountHeadMasterReport> InsertAccountHeadMasterReport(AccountHeadMasterReport item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountHeadMasterReport_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iHeadCode", SqlDbType.VarChar, 5, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, item.HeadCode));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountHeadMasterReport_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
        ...
        public IBaseEntityResponse<AccountHeadMasterReport> UpdateAccountHeadMasterReport(AccountHeadMasterReport item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountHeadMasterReport_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountHeadMasterReport_Insert' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityResponse<AccountHeadMasterReport> DeleteAccountHeadMasterReport(AccountHeadMasterReport item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountHeadMasterReport_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountHeadMasterReport_Delete' reported the ErrorCode: " + _errorCode);
                    }
