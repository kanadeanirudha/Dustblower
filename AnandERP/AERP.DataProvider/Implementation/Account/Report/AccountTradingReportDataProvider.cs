...
{
    public class AccountTradingReportDataProvider : DBInteractionBase, IAccountTradingReportDataProvider
    {
        ...
        /// </summary>
        public AccountTradingReportDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public AccountTradingReportDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<AccountTradingReport> GetAccountTradingReportBySearch(AccountTradingReportSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<AccountTradingReport> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<AccountTradingReport>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_AccountTrading_Report";
                    ...
                    baseEntityCollection.CollectionResponse = new List<AccountTradingReport>();
                    while (sqlDataReader.Read())
                    {
                        AccountTradingReport item = new AccountTradingReport();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_AccountTrading_Report' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<AccountTradingReport> GetAccountTradingReportByID(AccountTradingReport item)
        {
            IBaseEntityResponse<AccountTradingReport> response = new BaseEntityResponse<AccountTradingReport>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_AccountTradingReport_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        AccountTradingReport _item = new AccountTradingReport();
