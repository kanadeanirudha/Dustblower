...
{
    public class EmployeeLanguageDetailsDataProvider : DBInteractionBase, IEmployeeLanguageDetailsDataProvider
    {
        ...
        /// </summary>
        public EmployeeLanguageDetailsDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public EmployeeLanguageDetailsDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<EmployeeLanguageDetails> GetEmployeeLanguageDetailsBySearch(EmployeeLanguageDetailsSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<EmployeeLanguageDetails> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<EmployeeLanguageDetails>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_EmployeeLanguageDetails_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<EmployeeLanguageDetails>();
                    while (sqlDataReader.Read())
                    {
                        EmployeeLanguageDetails item = new EmployeeLanguageDetails();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_EmployeeLanguageDetails_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<EmployeeLanguageDetails> GetEmployeeLanguageDetailsByID(EmployeeLanguageDetailsSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EmployeeLanguageDetailsByID";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_EmployeeLanguageDetailsByID' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<EmployeeLanguageDetails> GetEmployeeLanguageDetailsByID(EmployeeLanguageDetails item)
        {
            IBaseEntityResponse<EmployeeLanguageDetails> response = new BaseEntityResponse<EmployeeLanguageDetails>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EmployeeLanguageDetails_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        EmployeeLanguageDetails _item = new EmployeeLanguageDetails();
        ...
        public IBaseEntityResponse<EmployeeLanguageDetails> InsertEmployeeLanguageDetails(EmployeeLanguageDetails item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EmployeeLanguageDetails_InsertXML";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                   ...
                   // item.ID = (Int32)cmdToExecute.Parameters["@iID"].Value;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_EmployeeLanguageDetails_InsertXML' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        public IBaseEntityResponse<EmployeeLanguageDetails> UpdateEmployeeLanguageDetails(EmployeeLanguageDetails item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EmployeeLanguageDetails_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iEmployeeID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.EmployeeID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iLanguageID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.LanguageID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_EmployeeLanguageDetails_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of EmployeeLanguageDetails
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<EmployeeLanguageDetails> DeleteEmployeeLanguageDetails(EmployeeLanguageDetails item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EmployeeLanguageDetails_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
