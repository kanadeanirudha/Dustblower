...
namespace AERP.DataProvider
{
    public class SalesOrderMasterAndDetailsDataProvider : DBInteractionBase, ISalesOrderMasterAndDetailsDataProvider
    {
            ...
            try
            {
                ...
                else
                {
                   ...
                   cmdToExecute.Connection = _mainConnection;
                    ...
                    if (item.SelectedDepartmentID == "" || item.SelectedDepartmentID == null)
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@iDepartmentID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, 0));
                    }
                    else
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@iDepartmentID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.SelectedDepartmentID));
                    }
                    cmdToExecute.Parameters.Add(new SqlParameter("@bIsCreatePR", SqlDbType.Bit,1, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.CreatePR));
        ...
        public IBaseEntityResponse<SalesOrderMasterAndDetails> InsertSalesOrderApproval(SalesOrderMasterAndDetails item)
        {
            IBaseEntityResponse<SalesOrderMasterAndDetails> response = new BaseEntityResponse<SalesOrderMasterAndDetails>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SalesOrderApproval_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iSalesOrderMasterID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.ID));
        ...
        public IBaseEntityCollectionResponse<SalesOrderMasterAndDetails> GetSalesOrderForApproval(SalesOrderMasterAndDetailsSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SalesOrderMasterAndDetails> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SalesOrderMasterAndDetails>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SalesOrder_GetRequestForApproval";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
