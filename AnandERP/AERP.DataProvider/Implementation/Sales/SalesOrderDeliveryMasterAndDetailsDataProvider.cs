...
namespace AERP.DataProvider
{
    public class SalesOrderDeliveryMasterAndDetailsDataProvider : DBInteractionBase, ISalesOrderDeliveryMasterAndDetailsDataProvider
    {
        ...
        public IBaseEntityCollectionResponse<SalesOrderDeliveryMasterAndDetails> GetSalesOrderDeliveryMasterAndDetailsBySearch(SalesOrderDeliveryMasterAndDetailsSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@tiDMStatus", SqlDbType.TinyInt, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.DMStatus));
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.IsCancelled = sqlDataReader["IsCancelled"] is DBNull ? new bool() : Convert.ToBoolean(sqlDataReader["IsCancelled"]);
        ...
        public IBaseEntityResponse<SalesOrderDeliveryMasterAndDetails> InsertSalesOrderDeliveryMasterAndDetails(SalesOrderDeliveryMasterAndDetails item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@mPurchaseAmount", SqlDbType.Money, 0, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, item.PurchaseAmount));
                    cmdToExecute.Parameters.Add(new SqlParameter("@mPurchaseBillAmount", SqlDbType.Money, 0, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, item.PurchaseBillAmount));
        ...
        public IBaseEntityCollectionResponse<SalesOrderDeliveryMasterAndDetails> GetDeliveryMemoSaleOrderDetailsByID(SalesOrderDeliveryMasterAndDetailsSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SalesOrderDeliveryMasterAndDetails> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SalesOrderDeliveryMasterAndDetails>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleOrderDeliveryGetByDMNumber";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iDeliveryNumberID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                        // Open connection.
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        _item.SalesOrderDeliveryMasterID = Convert.ToInt32(sqlDataReader["SalesOrderDeliveryMasterID"]);
                        _item.CustomerMasterID = sqlDataReader["CustomerId"] is DBNull ? new Int32() : Convert.ToInt32(sqlDataReader["CustomerId"]);
                        _item.CustomerBranchMasterID = sqlDataReader["CustomerBranchID"] is DBNull ? new Int32() : Convert.ToInt32(sqlDataReader["CustomerBranchID"]);
                        _item.ItemNumber = sqlDataReader["ItemNumber"] is DBNull ? 0 : Convert.ToInt32(sqlDataReader["ItemNumber"]);
                        _item.ItemDescription = sqlDataReader["ItemDescription"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["ItemDescription"]);

                        _item.DispatchedQuantity = sqlDataReader["DispatchedQuantity"] is DBNull ? 0 : Convert.ToDecimal(sqlDataReader["DispatchedQuantity"]);
                        _item.PurchasePrice = sqlDataReader["PurchaseCost"] is DBNull ? 0 : Convert.ToDecimal(sqlDataReader["PurchaseCost"]);
                        _item.SalesUomCode = sqlDataReader["SaleUomCode"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["SaleUomCode"]);
                        _item.CustomerName = sqlDataReader["CustomerName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["CustomerName"]);
                        _item.DeliveryNumber = sqlDataReader["DeliveryNumber"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["DeliveryNumber"]);
                        _item.DeliveryTransDate = sqlDataReader["DeliveryTransDate"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["DeliveryTransDate"]);

                        _item.Rate = sqlDataReader["Price"] is DBNull ? new decimal() : Convert.ToDecimal(sqlDataReader["Price"]);
                        _item.SaleAmount = sqlDataReader["SaleAmount"] is DBNull ? new decimal() : Convert.ToDecimal(sqlDataReader["SaleAmount"]);
                        _item.PurchaseCostAmount = sqlDataReader["PurchaseCostAmount"] is DBNull ? new decimal() : Convert.ToDecimal(sqlDataReader["PurchaseCostAmount"]);
                        _item.PurchaseCostAmountWTGST = sqlDataReader["PurchaseCostAmountWTGST"] is DBNull ? new decimal() : Convert.ToDecimal(sqlDataReader["PurchaseCostAmountWTGST"]);
                        _item.SaleAmountWtGst = sqlDataReader["SaleAmountWtGst"] is DBNull ? new decimal() : Convert.ToDecimal(sqlDataReader["SaleAmountWtGst"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleOrderDeliveryGetByDMNumber' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        _item.WaterMark = sqlDataReader["WaterMark"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["WaterMark"]);
                        baseEntityCollection.CollectionResponse.Add(_item);
                    }
                    if (cmdToExecute.Parameters["@iErrorCode"].Value != null)
                    {
