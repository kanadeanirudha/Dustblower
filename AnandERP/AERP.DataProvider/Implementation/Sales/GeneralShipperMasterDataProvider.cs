...
{
    public class GeneralShipperMasterDataProvider : DBInteractionBase, IGeneralShipperMasterDataProvider
    {
        ...
        /// </summary>
        public GeneralShipperMasterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public GeneralShipperMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralShipperMaster> GetGeneralShipperMasterBySearch(GeneralShipperMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<GeneralShipperMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<GeneralShipperMaster>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_GeneralShipperMaster_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<GeneralShipperMaster>();
                    while (sqlDataReader.Read())
                    {
                        GeneralShipperMaster item = new GeneralShipperMaster();

                        item.ID = sqlDataReader["GeneralShipperMasterID"] is DBNull ? new short() : Convert.ToInt16(sqlDataReader["GeneralShipperMasterID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralShipperMaster_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<GeneralShipperMaster> GetGeneralShipperMasterSearchList(GeneralShipperMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralShipperMaster_GetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                    ...
                    {
                        GeneralShipperMaster item = new GeneralShipperMaster();
                        item.ID = Convert.ToInt16(sqlDataReader["GeneralShipperMasterID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralShipperMaster_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralShipperMaster> GetGeneralShipperMasterByID(GeneralShipperMaster item)
        {
            IBaseEntityResponse<GeneralShipperMaster> response = new BaseEntityResponse<GeneralShipperMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralShipperMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        GeneralShipperMaster _item = new GeneralShipperMaster();
        ...
        public IBaseEntityResponse<GeneralShipperMaster> InsertGeneralShipperMaster(GeneralShipperMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralShipperMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralShipperMasterID", SqlDbType.Int, 4,
                    ...
                    //if (_rowsAffected > 0)
                    //{
                    //    item.ID = (Int16)cmdToExecute.Parameters["@iGeneralShipperMasterID"].Value;
                    //}
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralShipperMaster_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<GeneralShipperMaster> UpdateGeneralShipperMaster(GeneralShipperMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralShipperMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_GeneralShipperMaster_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of GeneralShipperMaster
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<GeneralShipperMaster> DeleteGeneralShipperMaster(GeneralShipperMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralShipperMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralShipperMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
