...
{
    public class PurchaseReplenishmentDataProvider : DBInteractionBase, IPurchaseReplenishmentDataProvider
    {
        ...
        /// </summary>
        public PurchaseReplenishmentDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public PurchaseReplenishmentDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<PurchaseReplenishment> GetPurchaseReplenishmentBySearch(PurchaseReplenishmentSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<PurchaseReplenishment> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<PurchaseReplenishment>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_PurchaseReplenishment_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<PurchaseReplenishment>();
                    while (sqlDataReader.Read())
                    {
                        PurchaseReplenishment item = new PurchaseReplenishment();
                        item.ItemCount = sqlDataReader["ItemCount"] is DBNull ? 0 : Convert.ToInt32(sqlDataReader["ItemCount"]);
                        item.VendorID = sqlDataReader["GeneralVendorID"] is DBNull ? 0 : Convert.ToInt32(sqlDataReader["GeneralVendorID"]);
                        item.Price = sqlDataReader["Price"] is DBNull ? new decimal() : Convert.ToDecimal(sqlDataReader["Price"]);
        ...
        /// <returns></returns>
        public IBaseEntityResponse<PurchaseReplenishment> GetPurchaseReplenishmentByID(PurchaseReplenishment item)
        {
            IBaseEntityResponse<PurchaseReplenishment> response = new BaseEntityResponse<PurchaseReplenishment>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_PurchaseReplenishment_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        PurchaseReplenishment _item = new PurchaseReplenishment();
        ...
        public IBaseEntityResponse<PurchaseReplenishment> InsertPurchaseReplenishment(PurchaseReplenishment item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_PurchaseReplenishmentMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                 ...
                 //   item.TotalInvoiceAmount = TotalInvoiceAmount1;
                    ...
                    //cmdToExecute.Parameters.Add(new SqlParameter("@xPurchaseReplenishmentVoucherXML", SqlDbType.Xml, 0,
                    //                    ParameterDirection.Input, false, 0, 0, "",
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_PurchaseReplenishment_INSERT' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        public IBaseEntityResponse<PurchaseReplenishment> UpdatePurchaseReplenishment(PurchaseReplenishment item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_PurchaseReplenishment_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_PurchaseReplenishment_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of PurchaseReplenishment
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<PurchaseReplenishment> DeletePurchaseReplenishment(PurchaseReplenishment item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_PurchaseReplenishment_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityCollectionResponse<PurchaseReplenishment> GetPurchaseReplenishmentByPurchaseGRNMasterID(PurchaseReplenishmentSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<PurchaseReplenishment> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<PurchaseReplenishment>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_PurchaseReplenishmentMaster_SelectByPurchaseGRNMasterID";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
               ...
               //     cmdToExecute.Parameters.Add(new SqlParameter("@tiPurchaseOrderType", SqlDbType.TinyInt, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.PurchaseOrderType));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_PurchaseReplenishment_SelectByPurchaseRequisitionMasterID' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
