        ...
        public IBaseEntityCollectionResponse<PurchaseOrderMasterAndDetails> GetPurchaseOrderMasterAndDetailsBySearch(PurchaseOrderMasterAndDetailsSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@dtPurchaseOrderFromDate", SqlDbType.DateTime, 0, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.PurchaseOrderFromDate));
                    cmdToExecute.Parameters.Add(new SqlParameter("@dtPurchaseOrderUptoDate", SqlDbType.DateTime, 0, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.PurchaseOrderUptoDate));
