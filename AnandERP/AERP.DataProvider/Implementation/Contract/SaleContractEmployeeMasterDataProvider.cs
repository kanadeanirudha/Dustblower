        ...
        public IBaseEntityCollectionResponse<SaleContractEmployeeMaster> GetSaleContractEmployeeMasterBySearch(SaleContractEmployeeMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iEndRow", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.EndRow+500));
