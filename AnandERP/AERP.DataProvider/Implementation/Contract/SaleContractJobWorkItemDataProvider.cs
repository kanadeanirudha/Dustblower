...
{
    public class SaleContractJobWorkItemDataProvider : DBInteractionBase, ISaleContractJobWorkItemDataProvider
    {
        ...
        /// </summary>
        public SaleContractJobWorkItemDataProvider()
        {
        }
        ...
        public SaleContractJobWorkItemDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<SaleContractJobWorkItem> GetSaleContractJobWorkItemBySearch(SaleContractJobWorkItemSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractJobWorkItem> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractJobWorkItem>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_SaleContractJobWorkItem_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<SaleContractJobWorkItem>();
                    while (sqlDataReader.Read())
                    {
                        SaleContractJobWorkItem item = new SaleContractJobWorkItem();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractJobWorkItem_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <param name="searchRequest"></param>
        /// <returns></returns>
        public IBaseEntityCollectionResponse<SaleContractJobWorkItem> GetSaleContractJobWorkItemGetBySearchList(SaleContractJobWorkItemSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractJobWorkItem> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractJobWorkItem>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractJobWorkItem_SearchList";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractJobWorkItem_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<SaleContractJobWorkItem> GetSaleContractJobWorkItemByID(SaleContractJobWorkItem item)
        {
            IBaseEntityResponse<SaleContractJobWorkItem> response = new BaseEntityResponse<SaleContractJobWorkItem>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractJobWorkItem_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        SaleContractJobWorkItem _item = new SaleContractJobWorkItem();
        ...
        public IBaseEntityResponse<SaleContractJobWorkItem> InsertSaleContractJobWorkItem(SaleContractJobWorkItem item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractJobWorkItem_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@mRate", SqlDbType.Money, 0, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.Rate));
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractJobWorkItem_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
        ...
        public IBaseEntityResponse<SaleContractJobWorkItem> UpdateSaleContractJobWorkItem(SaleContractJobWorkItem item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractJobWorkItem_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@mRate", SqlDbType.Money, 0, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.Rate));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractJobWorkItem_Insert' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityResponse<SaleContractJobWorkItem> DeleteSaleContractJobWorkItem(SaleContractJobWorkItem item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractJobWorkItem_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractJobWorkItem_Delete' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (SqlException ex)
        ...
        public IBaseEntityCollectionResponse<SaleContractJobWorkItem> GetJobWorkItemBySearchWord(SaleContractJobWorkItemSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractJobWorkItem_SearchByWord";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
