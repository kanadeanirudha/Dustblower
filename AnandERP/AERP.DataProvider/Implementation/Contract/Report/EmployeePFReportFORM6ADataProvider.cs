...
{
    public class EmployeePFReportFORM6ADataProvider : DBInteractionBase, IEmployeePFReportFORM6ADataProvider
    {
        ...
        /// </summary>
        public EmployeePFReportFORM6ADataProvider()
        {
        }
        ...
        public EmployeePFReportFORM6ADataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<EmployeePFReportFORM6A> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<EmployeePFReportFORM6A>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_EmployeesProvidentFundsForm6A1";
                    ...
                    baseEntityCollection.CollectionResponse = new List<EmployeePFReportFORM6A>();
                    while (sqlDataReader.Read())
                    {
                        EmployeePFReportFORM6A item = new EmployeePFReportFORM6A();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_EmployeePFReportFORM6A_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
