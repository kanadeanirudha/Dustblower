...
{
    public class RegisterofDeductionsforDamageorLossDataProvider : DBInteractionBase, IRegisterofDeductionsforDamageorLossDataProvider
    {
        ...
        /// </summary>
        public RegisterofDeductionsforDamageorLossDataProvider()
        {
        }
        ...
        public RegisterofDeductionsforDamageorLossDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<RegisterofDeductionsforDamageorLoss> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<RegisterofDeductionsforDamageorLoss>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<RegisterofDeductionsforDamageorLoss>();
                    while (sqlDataReader.Read())
                    {
                        RegisterofDeductionsforDamageorLoss item = new RegisterofDeductionsforDamageorLoss();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_RegisterofDeductionsforDamageorLoss_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
