...
{
    public class PaymentOfBonusDataProvider : DBInteractionBase, IPaymentOfBonusDataProvider
    {
        ...
        /// </summary>
        public PaymentOfBonusDataProvider()
        {
        }
        ...
        public PaymentOfBonusDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<PaymentOfBonus> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<PaymentOfBonus>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<PaymentOfBonus>();
                    while (sqlDataReader.Read())
                    {
                        PaymentOfBonus item = new PaymentOfBonus();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_PaymentOfBonus_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
