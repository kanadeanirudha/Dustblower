...
{
    public class EmployeePFSummeryDataProvider : DBInteractionBase, IEmployeePFSummeryDataProvider
    {
        ...
        /// </summary>
        public EmployeePFSummeryDataProvider()
        {
        }
        ...
        public EmployeePFSummeryDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<EmployeePFSummery> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<EmployeePFSummery>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<EmployeePFSummery>();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_EmployeePFSummery_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
