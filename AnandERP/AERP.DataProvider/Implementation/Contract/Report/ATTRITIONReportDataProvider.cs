...
{
    public class ATTRITIONReportDataProvider : DBInteractionBase, IATTRITIONReportDataProvider
    {
        ...
        /// </summary>
        public ATTRITIONReportDataProvider()
        {
        }
        ...
        public ATTRITIONReportDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<ATTRITIONReport> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<ATTRITIONReport>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<ATTRITIONReport>();
                    while (sqlDataReader.Read())
                    {
                        ATTRITIONReport item = new ATTRITIONReport();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_ATTRITIONReport_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
