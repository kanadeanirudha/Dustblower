...
{
    public class RegisterofOvertimeDataProvider : DBInteractionBase, IRegisterofOvertimeDataProvider
    {
        ...
        /// </summary>
        public RegisterofOvertimeDataProvider()
        {
        }
        ...
        public RegisterofOvertimeDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<RegisterofOvertime> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<RegisterofOvertime>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<RegisterofOvertime>();
                    while (sqlDataReader.Read())
                    {
                        RegisterofOvertime item = new RegisterofOvertime();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_RegisterofOvertime_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
