...
{
    public class RegisterofWorkmenEmployedbyContractorDataProvider : DBInteractionBase, IRegisterofWorkmenEmployedbyContractorDataProvider
    {
        ...
        /// </summary>
        public RegisterofWorkmenEmployedbyContractorDataProvider()
        {
        }
        ...
        public RegisterofWorkmenEmployedbyContractorDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<RegisterofWorkmenEmployedbyContractor> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<RegisterofWorkmenEmployedbyContractor>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<RegisterofWorkmenEmployedbyContractor>();
                    while (sqlDataReader.Read())
                    {
                        RegisterofWorkmenEmployedbyContractor item = new RegisterofWorkmenEmployedbyContractor();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_RegisterofWorkmenEmployedbyContractor_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
