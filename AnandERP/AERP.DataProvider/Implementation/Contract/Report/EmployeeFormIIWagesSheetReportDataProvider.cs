...
{
    public class EmployeeFormIIWagesSheetReportDataProvider : DBInteractionBase, IEmployeeFormIIWagesSheetReportDataProvider
    {
        ...
        /// </summary>
        public EmployeeFormIIWagesSheetReportDataProvider()
        {
        }
        ...
        public EmployeeFormIIWagesSheetReportDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<EmployeeFormIIWagesSheetReport> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<EmployeeFormIIWagesSheetReport>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<EmployeeFormIIWagesSheetReport>();
                    while (sqlDataReader.Read())
                    {
                        EmployeeFormIIWagesSheetReport item = new EmployeeFormIIWagesSheetReport();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_EmployeeFormIIWagesSheetReport_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
