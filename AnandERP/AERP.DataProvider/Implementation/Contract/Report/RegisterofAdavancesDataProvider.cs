...
{
    public class RegisterofAdavancesDataProvider : DBInteractionBase, IRegisterofAdavancesDataProvider
    {
        ...
        /// </summary>
        public RegisterofAdavancesDataProvider()
        {
        }
        ...
        public RegisterofAdavancesDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<RegisterofAdavances> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<RegisterofAdavances>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<RegisterofAdavances>();
                    while (sqlDataReader.Read())
                    {
                        RegisterofAdavances item = new RegisterofAdavances();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_RegisterofAdavances_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
