...
namespace AERP.DataProvider
{
    public class ContractSalaryBonusReportDataProvider : DBInteractionBase, IContractSalaryBonusReportDataProvider
    {
        ...
        public IBaseEntityCollectionResponse<ContractSalaryBonusReport> GetContractSalaryBonusReportDataList(ContractSalaryBonusReportSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iCustomerBranchMasterID", SqlDbType.BigInt, 0, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.CustomerBranchMasterID));
        ...
        public IBaseEntityCollectionResponse<ContractSalaryBonusReport> GetContractSalaryBonusATMReportDataList(ContractSalaryBonusReportSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<ContractSalaryBonusReport> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<ContractSalaryBonusReport>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_ContractSalaryBonusATMReport_SelectAll";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.CommandTimeout = 0;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@dtFromDate", SqlDbType.NVarChar, 35, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.FromDate));
                    ...
                    {
                        ContractSalaryBonusReport item = new ContractSalaryBonusReport();
                        item.Amount = sqlDataReader["BonusAmount"] is DBNull ? new decimal() : Convert.ToDecimal(sqlDataReader["BonusAmount"]);
                        item.EmployeeName = sqlDataReader["EmployeeName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["EmployeeName"]);
                        item.AccountNumber = sqlDataReader["BankACNumber"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["BankACNumber"]);
                        item.CustomerBranchMasterName = sqlDataReader["BranchName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["BranchName"]);
