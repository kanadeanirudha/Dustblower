...
{
    public class RegisterofFinesDataProvider : DBInteractionBase, IRegisterofFinesDataProvider
    {
        ...
        /// </summary>
        public RegisterofFinesDataProvider()
        {
        }
        ...
        public RegisterofFinesDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityCollectionResponse<RegisterofFines> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<RegisterofFines>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<RegisterofFines>();
                    while (sqlDataReader.Read())
                    {
                        RegisterofFines item = new RegisterofFines();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_RegisterofFines_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
