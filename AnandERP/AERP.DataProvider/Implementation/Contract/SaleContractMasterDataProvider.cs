...
namespace AERP.DataProvider
{
    public class SaleContractMasterDataProvider : DBInteractionBase, ISaleContractMasterDataProvider
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.ApprovalStatus = sqlDataReader["ApprovalStatus"] is DBNull ? new byte() : Convert.ToByte(sqlDataReader["ApprovalStatus"]);
        ...
        public IBaseEntityCollectionResponse<SaleContractMaster> GetContractNumberSearchList(SaleContractMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsCentreCode", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, searchRequest.CentreCode == null ? "" : searchRequest.CentreCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                        // Open connection.
                        _mainConnection.Open();
        ...
        public IBaseEntityCollectionResponse<SaleContractMaster> GetContractNumberSearchListAll(SaleContractMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractMaster_SearchContractNumberAll";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsSearchWord", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, searchRequest.SearchWord));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iAdminRoleID", SqlDbType.Int, 0, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, searchRequest.AdminRoleID));
        ...
        public IBaseEntityCollectionResponse<SaleContractMaster> GetSaleContractForApproval(SaleContractMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContract_GetRequestForApproval";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
        ...
        public IBaseEntityResponse<SaleContractMaster> InsertSaleContractApproval(SaleContractMaster item)
        {
            IBaseEntityResponse<SaleContractMaster> response = new BaseEntityResponse<SaleContractMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractMasterApproval_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iSaleContractMasterID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.ID));
        ...
        public IBaseEntityResponse<SaleContractMaster> GetSaleContractApprovalStatus(SaleContractMaster item)
        {
            IBaseEntityResponse<SaleContractMaster> response = new BaseEntityResponse<SaleContractMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractMaster_GetApprovalStatus";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        _item.ApprovalStatus = sqlDataReader["ApprovalStatus"] is DBNull ? new byte() : Convert.ToByte(sqlDataReader["ApprovalStatus"]);
