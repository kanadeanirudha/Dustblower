...
namespace AERP.DataProvider
{
    public class SaleContractAttendanceDataProvider : DBInteractionBase, ISaleContractAttendanceDataProvider
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.SalaryForManPowerItemName= sqlDataReader["SalaryForManPowerItemName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["SalaryForManPowerItemName"]);
                        item.ApprovedStatus = sqlDataReader["ApprovedStatus"] is DBNull ? new byte() : Convert.ToByte(sqlDataReader["ApprovedStatus"]);
                        item.PreviousAttendanceDetails = sqlDataReader["PreviousAttendanceDetails"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["PreviousAttendanceDetails"]);
        ...
        public IBaseEntityResponse<SaleContractAttendance> InsertContractAttendanceApproval(SaleContractAttendance item)
        {
            IBaseEntityResponse<SaleContractAttendance> response = new BaseEntityResponse<SaleContractAttendance>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_ContractAttendanceApproval_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iSaleContractBillingSpanID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.ID));
        ...
        public IBaseEntityCollectionResponse<SaleContractAttendance> GetContractAttendanceForApproval(SaleContractAttendanceSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractAttendance> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractAttendance>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_ContractAttendance_GetRequestForApproval";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
