...
namespace AERP.DataProvider
{
    public class SaleContractFixAttendanceDataProvider : DBInteractionBase, ISaleContractFixAttendanceDataProvider
    {
        ...
        public IBaseEntityResponse<SaleContractFixAttendance> InsertContractFixAttendanceApproval(SaleContractFixAttendance item)
        {
            IBaseEntityResponse<SaleContractFixAttendance> response = new BaseEntityResponse<SaleContractFixAttendance>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_ContractFixAttendanceApproval_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        public IBaseEntityCollectionResponse<SaleContractFixAttendance> GetContractFixAttendanceForApproval(SaleContractFixAttendanceSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractFixAttendance> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractFixAttendance>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_ContractFixAttendance_GetRequestForApproval";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
