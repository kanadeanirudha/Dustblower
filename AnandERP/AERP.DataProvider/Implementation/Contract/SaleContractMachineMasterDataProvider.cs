        ...
        public IBaseEntityResponse<SaleContractMachineMaster> UpdateSaleContractMachineMaster(SaleContractMachineMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (item.NextMaintanceDate != null)
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@dtNextMaintanceDate", SqlDbType.NVarChar, 35, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.NextMaintanceDate));
                    }
                    else
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@dtNextMaintanceDate", SqlDbType.NVarChar, 35, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, DBNull.Value));
                    }
                    if (item.PurchaseDate != null)
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@dtPurchaseDate", SqlDbType.NVarChar, 35, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.PurchaseDate));
                    }
                    else
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@dtPurchaseDate", SqlDbType.NVarChar, 35, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, DBNull.Value));
                    }
                    cmdToExecute.Parameters.Add(new SqlParameter("@mPurchaseCost", SqlDbType.Money, 0, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.PurchaseCost));
