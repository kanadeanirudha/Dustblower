...
{
    public class SaleContractFixItemDataProvider : DBInteractionBase, ISaleContractFixItemDataProvider
    {
        ...
        /// </summary>
        public SaleContractFixItemDataProvider()
        {
        }
        ...
        public SaleContractFixItemDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<SaleContractFixItem> GetSaleContractFixItemBySearch(SaleContractFixItemSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractFixItem> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractFixItem>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_SaleContractFixItem_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<SaleContractFixItem>();
                    while (sqlDataReader.Read())
                    {
                        SaleContractFixItem item = new SaleContractFixItem();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractFixItem_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <param name="searchRequest"></param>
        /// <returns></returns>
        public IBaseEntityCollectionResponse<SaleContractFixItem> GetSaleContractFixItemGetBySearchList(SaleContractFixItemSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractFixItem> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractFixItem>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractFixItem_SearchList";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractFixItem_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<SaleContractFixItem> GetSaleContractFixItemByID(SaleContractFixItem item)
        {
            IBaseEntityResponse<SaleContractFixItem> response = new BaseEntityResponse<SaleContractFixItem>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractFixItem_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        SaleContractFixItem _item = new SaleContractFixItem();
        ...
        public IBaseEntityResponse<SaleContractFixItem> InsertSaleContractFixItem(SaleContractFixItem item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractFixItem_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;


                    cmdToExecute.Parameters.Add(new SqlParameter("@nsName", SqlDbType.NVarChar, 100, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.Name.Trim()));
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractFixItem_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
        ...
        public IBaseEntityResponse<SaleContractFixItem> UpdateSaleContractFixItem(SaleContractFixItem item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractFixItem_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractFixItem_Insert' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityResponse<SaleContractFixItem> DeleteSaleContractFixItem(SaleContractFixItem item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractFixItem_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_SaleContractFixItem_Delete' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (SqlException ex)
        ...
        public IBaseEntityCollectionResponse<SaleContractFixItem> GetFixItemBySearchWord(SaleContractFixItemSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractFixItem_SearchByWord";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
