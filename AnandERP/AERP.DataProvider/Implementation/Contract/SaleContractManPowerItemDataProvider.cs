...
namespace AERP.DataProvider
{
    public class SaleContractManPowerItemDataProvider : DBInteractionBase, ISaleContractManPowerItemDataProvider
    {
        ...
        public IBaseEntityResponse<SaleContractManPowerItem> UpdateSaleContractManPowerItemRules(SaleContractManPowerItem item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if(item.WithEffectiveFromDate != null)
                    {
                        ...
                        cmdToExecute.Parameters.Add(new SqlParameter("@dtWithEffectiveFromDate", SqlDbType.DateTime, 0, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, DBNull.Value));
                    if (item.WithEffectiveUptoDate != null)
                    {
                        ...
                        cmdToExecute.Parameters.Add(new SqlParameter("@dtWithEffectiveUptoDate", SqlDbType.DateTime, 0, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, DBNull.Value));
        ...
        public IBaseEntityResponse<SaleContractManPowerItem> InsertManPowerItemApproval(SaleContractManPowerItem item)
        {
            IBaseEntityResponse<SaleContractManPowerItem> response = new BaseEntityResponse<SaleContractManPowerItem>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SaleContractManPowerItemApproval_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.CommandTimeout = 0;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iSaleContractManPowerItemID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.ID));
        ...
        public IBaseEntityCollectionResponse<SaleContractManPowerItem> GetManPowerItemForApproval(SaleContractManPowerItemSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<SaleContractManPowerItem> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<SaleContractManPowerItem>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_ManPowerItem_GetRequestForApproval";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.CustomerBranchMasterName = sqlDataReader["CustomerBranchMasterName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["CustomerBranchMasterName"]);
                        item.DesignationMasterName = sqlDataReader["DesignationMasterName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["DesignationMasterName"]);
                        item.ID = sqlDataReader["SaleContractManPowerItemID"] is DBNull ? new Int32() : Convert.ToInt32(sqlDataReader["SaleContractManPowerItemID"]);
