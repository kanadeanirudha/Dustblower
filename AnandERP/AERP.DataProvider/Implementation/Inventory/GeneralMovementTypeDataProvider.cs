...
{
    public class GeneralMovementTypeDataProvider : DBInteractionBase, IGeneralMovementTypeDataProvider
    {
        ...
        /// </summary>
        public GeneralMovementTypeDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public GeneralMovementTypeDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralMovementType> GetGeneralMovementTypeBySearch(GeneralMovementTypeSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<GeneralMovementType> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<GeneralMovementType>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_GeneralMovementType_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<GeneralMovementType>();
                    while (sqlDataReader.Read())
                    {
                        GeneralMovementType item = new GeneralMovementType();

                        item.ID = sqlDataReader["GeneralMovementTypeID"] is DBNull ? new short() : Convert.ToInt16(sqlDataReader["GeneralMovementTypeID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralMovementType_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<GeneralMovementType> GetGeneralMovementTypeSearchList(GeneralMovementTypeSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralMovementType_GetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                    ...
                    {
                        GeneralMovementType item = new GeneralMovementType();
                        item.ID = Convert.ToInt16(sqlDataReader["GeneralMovementTypeID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralMovementType_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralMovementType> GetGeneralMovementTypeByID(GeneralMovementType item)
        {
            IBaseEntityResponse<GeneralMovementType> response = new BaseEntityResponse<GeneralMovementType>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralMovementType_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        GeneralMovementType _item = new GeneralMovementType();
        ...
        public IBaseEntityResponse<GeneralMovementType> InsertGeneralMovementType(GeneralMovementType item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralMovementType_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralMovementTypeID", SqlDbType.Int, 4,
                                            ParameterDirection.Output, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsMovementType", SqlDbType.NVarChar, 200,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.MovementType));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsMovementCode", SqlDbType.NVarChar, 20,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.MovementCode));
                    ...
                    //if (_rowsAffected > 0)
                    //{
                    //    item.ID = (Int16)cmdToExecute.Parameters["@iGeneralMovementTypeID"].Value;
                    //}
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_GeneralMovementType_Insert' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralMovementType_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<GeneralMovementType> UpdateGeneralMovementType(GeneralMovementType item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralMovementType_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_GeneralMovementType_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of GeneralMovementType
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<GeneralMovementType> DeleteGeneralMovementType(GeneralMovementType item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralMovementType_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralMovementType_Delete' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityResponse<GeneralMovementType> InsertGeneralMovementTypeRules(GeneralMovementType item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralMovementTypeRules_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralMovementTypeRulesID", SqlDbType.Int, 4,
                                            ParameterDirection.Output, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.MovementTypeRulesID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@tiMovementTypeID", SqlDbType.TinyInt, 5,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iTransactionType", SqlDbType.Int, 4,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.TransactionType));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iDirection", SqlDbType.Int, 4,
                                          ParameterDirection.Input, false, 10, 0, "",
                                          DataRowVersion.Proposed, item.Direction));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsRequisitionBehaviour", SqlDbType.NVarChar, 10,
                                          ParameterDirection.Input, false, 10, 0, "",
                                          DataRowVersion.Proposed, item.Behaviour));
                    cmdToExecute.Parameters.Add(new SqlParameter("@tiAction", SqlDbType.TinyInt, 5,
                                           ParameterDirection.Input, false, 10, 0, "",
                                           DataRowVersion.Proposed, item.Action));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iCreatedBy", SqlDbType.Int, 4,
                                           ParameterDirection.Input, true, 10, 0, "",
                                           DataRowVersion.Proposed, item.CreatedBy));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4,
