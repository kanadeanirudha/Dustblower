...
{
    public class GeneralUnitsStorageLocationDataProvider : DBInteractionBase, IGeneralUnitsStorageLocationDataProvider
    {
        ...
        /// </summary>
        public GeneralUnitsStorageLocationDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public GeneralUnitsStorageLocationDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralUnitsStorageLocation> GetGeneralUnitsStorageLocationBySearch(GeneralUnitsStorageLocationSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<GeneralUnitsStorageLocation> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<GeneralUnitsStorageLocation>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<GeneralUnitsStorageLocation>();
                    while (sqlDataReader.Read())
                    {
                        GeneralUnitsStorageLocation item = new GeneralUnitsStorageLocation();
                        item.ID = sqlDataReader["GeneralUnitsStorageLocationID"] is DBNull ? new short() : Convert.ToInt16(sqlDataReader["GeneralUnitsStorageLocationID"]);
                        item.GeneralUnitsID = sqlDataReader["GeneralUnitsIDA"] is DBNull ? new short() : Convert.ToInt16(sqlDataReader["GeneralUnitsIDA"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralUnitsStorageLocation_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<GeneralUnitsStorageLocation> GetGeneralUnitsStorageLocationSearchList(GeneralUnitsStorageLocationSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_SearchList_BalsheetMstIDWise";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                  ...
                  //  cmdToExecute.Parameters.Add(new SqlParameter("@iAccBalsheetMstID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.AccBalsheetMstID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralUnitsStorageLocation_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralUnitsStorageLocation> GetGeneralUnitsStorageLocationByID(GeneralUnitsStorageLocation item)
        {
            IBaseEntityResponse<GeneralUnitsStorageLocation> response = new BaseEntityResponse<GeneralUnitsStorageLocation>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        GeneralUnitsStorageLocation _item = new GeneralUnitsStorageLocation();
                       
                        _item.GeneralUnitsID = sqlDataReader["GeneralUnitsID"] is DBNull ? new short() : Convert.ToInt16(sqlDataReader["GeneralUnitsID"].ToString());
                        _item.IsDefault = Convert.ToBoolean(sqlDataReader["IsDefault"]);
                        _item.InventoryLocationMasterID = sqlDataReader["InventoryLocationMasterID"] is DBNull ? 0 : Convert.ToInt32(sqlDataReader["InventoryLocationMasterID"]);
                        _item.UnitName = sqlDataReader["UnitName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["UnitName"]);
                        _item.LocationName = sqlDataReader["LocationName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["LocationName"]);
        ...
        public IBaseEntityResponse<GeneralUnitsStorageLocation> InsertGeneralUnitsStorageLocation(GeneralUnitsStorageLocation item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_InsertXML";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@xGeneralUnitsStorageLocationXml", SqlDbType.Xml,0,
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_GeneralUnitsStorageLocation_INSERT' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralUnitsStorageLocation_INSERT' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<GeneralUnitsStorageLocation> UpdateGeneralUnitsStorageLocation(GeneralUnitsStorageLocation item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                   ...
                   // item.ID = (Int32)cmdToExecute.Parameters["@iID"].Value;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_GeneralUnitsStorageLocation_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of GeneralUnitsStorageLocation
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<GeneralUnitsStorageLocation> DeleteGeneralUnitsStorageLocation(GeneralUnitsStorageLocation item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralUnitsStorageLocation_Delete' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityResponse<GeneralUnitsStorageLocation> CheckFocusOnAction(GeneralUnitsStorageLocation item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_CheckFocusOnAction";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        else
                        {
                            ...
                            _item.IsDefaultCount = Convert.ToInt32(sqlDataReader["IsDefaultCount"]);
                            response.Entity = _item;
                        }
                    }
                    if (cmdToExecute.Parameters["@iErrorCode"].Value != null)
        ...
        public IBaseEntityCollectionResponse<GeneralUnitsStorageLocation> GetStorageLocationForRequisition(GeneralUnitsStorageLocationSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_GetListForRequisition";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        GeneralUnitsStorageLocation item = new GeneralUnitsStorageLocation();
                        item.InventoryLocationMasterID = sqlDataReader["InventoryLocationMasterID"] is DBNull ? 0 : Convert.ToInt32(sqlDataReader["InventoryLocationMasterID"]);
                        item.LocationName = sqlDataReader["LocationName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["LocationName"]);
                        baseEntityCollection.CollectionResponse.Add(item);
                    }
                    if (cmdToExecute.Parameters["@iErrorCode"].Value != null)
