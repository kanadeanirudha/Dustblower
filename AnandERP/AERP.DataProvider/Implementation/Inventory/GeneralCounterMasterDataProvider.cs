...
{
    public class GeneralCounterMasterDataProvider: DBInteractionBase, IGeneralCounterMasterDataProvider
    {
        ...
        /// </summary>
        public GeneralCounterMasterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public GeneralCounterMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralCounterMaster> GetGeneralCounterMasterBySearch(GeneralCounterMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<GeneralCounterMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<GeneralCounterMaster>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_GeneralCounterMaster_SelectAll";
                 ...
                 //   cmdToExecute.Parameters.Add(new SqlParameter("@iDepartmentID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.DepartmentID));
                    ...
                    baseEntityCollection.CollectionResponse = new List<GeneralCounterMaster>();
                    while (sqlDataReader.Read())
                    {
                        GeneralCounterMaster item = new GeneralCounterMaster();

                        item.ID = sqlDataReader["GeneralCounterMasterID"] is DBNull ? new short() : Convert.ToInt16(sqlDataReader["GeneralCounterMasterID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralCounterMaster_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralCounterMaster> GetGeneralCounterMasterByID(GeneralCounterMaster item)
        {
            IBaseEntityResponse<GeneralCounterMaster> response = new BaseEntityResponse<GeneralCounterMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCounterMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        GeneralCounterMaster _item = new GeneralCounterMaster();
                        _item.ID = sqlDataReader["ID"] is DBNull ? new short() : Convert.ToInt16(sqlDataReader["ID"]);
                        _item.CounterName = sqlDataReader["CounterName"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["CounterName"]);
                        _item.CounterCode = sqlDataReader["CounterCode"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["CounterCode"]);
        ...
        public IBaseEntityResponse<GeneralCounterMaster> InsertGeneralCounterMaster(GeneralCounterMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCounterMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralCounterMasterID", SqlDbType.Int, 4,
                                            ParameterDirection.Output, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsCounterName", SqlDbType.NVarChar, 50,
        ...
        public IBaseEntityResponse<GeneralCounterMaster> UpdateGeneralCounterMaster(GeneralCounterMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCounterMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        public IBaseEntityResponse<GeneralCounterMaster> DeleteGeneralCounterMaster(GeneralCounterMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralCounterMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
