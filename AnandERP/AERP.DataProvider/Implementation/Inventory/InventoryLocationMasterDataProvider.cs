...
{
    public class InventoryLocationMasterDataProvider : DBInteractionBase, IInventoryLocationMasterDataProvider
    {
        ...
        /// </summary>
        public InventoryLocationMasterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public InventoryLocationMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<InventoryLocationMaster> GetInventoryLocationMasterBySearch(InventoryLocationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMaster_SelectAll";
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_InventoryLocationMaster_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<InventoryLocationMaster> GetInventoryLocationMasterList(InventoryLocationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMaster_SearchList";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsCentreCode", SqlDbType.NVarChar, 30, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, searchRequest.CentreCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                        // Open connection.
                        _mainConnection.Open();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_InventoryLocationMaster_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<InventoryLocationMaster> GetInventoryLocationMasterByID(InventoryLocationMaster item)
        {
            IBaseEntityResponse<InventoryLocationMaster> response = new BaseEntityResponse<InventoryLocationMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        InventoryLocationMaster _item = new InventoryLocationMaster();
                        _item.ID = Convert.ToInt32(sqlDataReader["ID"]);
                        _item.LocationName = sqlDataReader["LocationName"].ToString();
                      //  _item.AccBalanceSheetID = Convert.ToInt32(sqlDataReader["BalasheetId"]);
        ...
        public IBaseEntityResponse<InventoryLocationMaster> InsertInventoryLocationMaster(InventoryLocationMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iInventoryLocationMasterID", SqlDbType.Int, 10,
                                            ParameterDirection.Output, false, 0, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsLocationName", SqlDbType.NVarChar, 50,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.LocationName));
        ...
        public IBaseEntityResponse<InventoryLocationMaster> UpdateInventoryLocationMaster(InventoryLocationMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_InventoryLocationMaster_Update' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of InventoryLocationMaster
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<InventoryLocationMaster> DeleteInventoryLocationMaster(InventoryLocationMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_InventoryLocationMaster_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        public IBaseEntityCollectionResponse<InventoryLocationMaster> GetInventoryLocationMasterSearchList(InventoryLocationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMasterV2_SearchList";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
        ...
        public IBaseEntityCollectionResponse<InventoryLocationMaster> GetInventoryLocationMasterlistCenterCodeWise(InventoryLocationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationMaster_SearchListUsingCentreCode";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        InventoryLocationMaster item = new InventoryLocationMaster();
                        item.ID = Convert.ToInt32(sqlDataReader["LocationID"]);
                        item.LocationName = sqlDataReader["LocationName"].ToString();
                        // item.AccBalanceSheetID = Convert.ToInt32(sqlDataReader["BalasheetId"]);
        ...
        public IBaseEntityCollectionResponse<InventoryLocationMaster> GetInventoryLocationMasterlistByAdminRole(InventoryLocationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_InventoryLocationDropdown_byAdminRoleMasterID";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.ID = Convert.ToInt32(sqlDataReader["ID"]);
                        item.LocationName = sqlDataReader["LocationName"].ToString();
                        item.CentreCode = sqlDataReader["CentreName"].ToString();
                        // item.AccBalanceSheetID = Convert.ToInt32(sqlDataReader["BalasheetId"]);
        ...
        public IBaseEntityCollectionResponse<InventoryLocationMaster> GetInventoryStorageLocationByCentreCodeAndUnitsID(InventoryLocationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralUnitsStorageLocation_GetListForManualPurchase";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        InventoryLocationMaster item = new InventoryLocationMaster();
                        item.ID = Convert.ToInt32(sqlDataReader["InventoryLocationMasterID"]);
                        item.LocationName = sqlDataReader["LocationName"].ToString();
        ...
        public IBaseEntityResponse<InventoryLocationMaster> GetUnitsNameByLocationID(InventoryLocationMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GetUnitsIDBylocationMasterID_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iLocationMasterID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                        // Open connection.
                    ...
                    {
                        InventoryLocationMaster _item = new InventoryLocationMaster();
                        _item.GeneralUnitsID = Convert.ToInt16(sqlDataReader["GeneralUnitsID"]);
                        //_item.LocationName = sqlDataReader["LocationName"].ToString();
                        //  _item.AccBalanceSheetID = Convert.ToInt32(sqlDataReader["BalasheetId"]);
