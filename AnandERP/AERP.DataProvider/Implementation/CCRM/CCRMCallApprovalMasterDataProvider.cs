...
{
   public class CCRMCallApprovalMasterDataProvider:DBInteractionBase,ICCRMCallApprovalMasterDataProvider
    {
        ...
        #endregion
        #region Constructor
        public CCRMCallApprovalMasterDataProvider()
        {
        }
        public CCRMCallApprovalMasterDataProvider(ILogger logException)
        {
        ...
        {
            IBaseEntityResponse<CCRMCallApprovalMaster> response = new BaseEntityResponse<CCRMCallApprovalMaster>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_CCRMCallApprovalMaster_Update";
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_CCRMCallApprovalMaster_Insert' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityResponse<CCRMCallApprovalMaster> DeleteCCRMCallApprovalMaster(CCRMCallApprovalMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_CCRMCallApprovalMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_CCRMCallApprovalMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityResponse<CCRMCallApprovalMaster> GetCCRMCallApprovalMasterByID(CCRMCallApprovalMaster item)
        {
            IBaseEntityResponse<CCRMCallApprovalMaster> response = new BaseEntityResponse<CCRMCallApprovalMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_CCRMCallApprovalMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        CCRMCallApprovalMaster _item = new CCRMCallApprovalMaster();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_CCRMCallApprovalMaster_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<CCRMCallApprovalMaster> GetCCRMCallApprovalMasterBySearch(CCRMCallApprovalMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<CCRMCallApprovalMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<CCRMCallApprovalMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_CCRMCallApprovalMaster_SelectAll";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    baseEntityCollection.CollectionResponse = new List<CCRMCallApprovalMaster>();
                    while (sqlDataReader.Read())
                    {
                        CCRMCallApprovalMaster item = new CCRMCallApprovalMaster();
                        ...
                        item.CustApproval = Convert.ToBoolean(sqlDataReader["CustApproval"]);
